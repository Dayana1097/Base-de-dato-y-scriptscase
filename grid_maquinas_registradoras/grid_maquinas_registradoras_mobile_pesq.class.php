...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "codigo";$Nm_numeric[] = "piso";$Nm_numeric[] = "codigo";$Nm_numeric[] = "piso";
...
<HTML>
<HEAD>
 <TITLE> maquinas_registradoras</TITLE>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_piso_cond" name="piso_cond" onChange="nm_campos_between(document.getElementById('id_vis_piso'), this, 'piso')">
      ...
      <br><span id="id_hide_piso"  <?php echo $str_hide_piso?>><INPUT  type="text" id="SC_piso" name="piso" value="<?php echo NM_encode_input($piso) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
