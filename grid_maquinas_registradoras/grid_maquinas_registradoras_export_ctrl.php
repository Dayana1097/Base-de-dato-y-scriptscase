<?php
@session_start() ;
$_SESSION['scriptcase']['grid_maquinas_registradoras']['sc_process_barr'] = true;
require_once('../grid_maquinas_registradoras/index.php');
unset($_SESSION['scriptcase']['grid_maquinas_registradoras']['sc_process_barr']);
$ExportCtrl = new grid_maquinas_registradoras_export_control;
$ExportCtrl->Export_barr();

class grid_maquinas_registradoras_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> maquinas_registradoras :: Excel</TITLE>
