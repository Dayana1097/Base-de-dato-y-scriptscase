<?php  
  ...
  session_start() ;
  class grid_maquinas_registradoras_form_teste
  {
  function grid_maquinas_registradoras_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_maquinas_registradoras</FONT></B> 
<br> 
<br> 
...
<input type=submit value="grid_maquinas_registradoras"> 
</form> 
...
<?php
  ...
  $frm_teste = new grid_maquinas_registradoras_form_teste();
  $frm_teste->grid_maquinas_registradoras_teste();
?>
