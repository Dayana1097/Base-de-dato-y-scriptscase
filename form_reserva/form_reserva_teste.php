<?php  
  ...
  session_start() ;
  class form_reserva_form_teste
  {
   function form_reserva_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_reserva/img";
...
<?php
  ...
  $frm_teste = new form_reserva_form_teste();
  $frm_teste->form_reserva_teste();
?>
