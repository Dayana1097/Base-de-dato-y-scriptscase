  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_reserva" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_reserva_form();
	}

  // ---------- Validate id_
  function do_ajax_form_reserva_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldText(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reserva_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_reserva_validate_id__cb);
  } // do_ajax_form_reserva_validate_id_

  function do_ajax_form_reserva_validate_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reserva_validate_id__cb

  // ---------- Validate dni_
  function do_ajax_form_reserva_validate_dni_(iNumLinha)
  {
    var nomeCampo_dni_ = "dni_" + iNumLinha;
    var var_dni_ = scAjaxGetFieldText(nomeCampo_dni_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reserva_validate_dni_(var_dni_, iNumLinha, var_script_case_init, do_ajax_form_reserva_validate_dni__cb);
  } // do_ajax_form_reserva_validate_dni_

  function do_ajax_form_reserva_validate_dni__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "dni_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "dni_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reserva_validate_dni__cb

  // ---------- Validate numserie_
  function do_ajax_form_reserva_validate_numserie_(iNumLinha)
  {
    var nomeCampo_numserie_ = "numserie_" + iNumLinha;
    var var_numserie_ = scAjaxGetFieldText(nomeCampo_numserie_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reserva_validate_numserie_(var_numserie_, iNumLinha, var_script_case_init, do_ajax_form_reserva_validate_numserie__cb);
  } // do_ajax_form_reserva_validate_numserie_

  function do_ajax_form_reserva_validate_numserie__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "numserie_" + iLineNumber;
    }
    else
    {
      sFieldValid = "numserie_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "numserie_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "numserie_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reserva_validate_numserie__cb

  // ---------- Validate comienzo_
  function do_ajax_form_reserva_validate_comienzo_(iNumLinha)
  {
    var nomeCampo_comienzo_ = "comienzo_" + iNumLinha;
    var var_comienzo_ = scAjaxGetFieldText(nomeCampo_comienzo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reserva_validate_comienzo_(var_comienzo_, iNumLinha, var_script_case_init, do_ajax_form_reserva_validate_comienzo__cb);
  } // do_ajax_form_reserva_validate_comienzo_

  function do_ajax_form_reserva_validate_comienzo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "comienzo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "comienzo_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "comienzo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "comienzo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reserva_validate_comienzo__cb

  // ---------- Validate fin_
  function do_ajax_form_reserva_validate_fin_(iNumLinha)
  {
    var nomeCampo_fin_ = "fin_" + iNumLinha;
    var var_fin_ = scAjaxGetFieldText(nomeCampo_fin_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reserva_validate_fin_(var_fin_, iNumLinha, var_script_case_init, do_ajax_form_reserva_validate_fin__cb);
  } // do_ajax_form_reserva_validate_fin_

  function do_ajax_form_reserva_validate_fin__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "fin_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fin_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_reserva_validate_fin__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_reserva_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_reserva_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_reserva_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_reserva_add_new_line_cb);
  } // do_ajax_form_reserva_add_new_line

  function do_ajax_form_reserva_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_reserva_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_reserva_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldText("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_reserva_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_reserva_backup_line_cb);
  } // do_ajax_form_reserva_backup_line

  function do_ajax_form_reserva_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_reserva_backup_line_cb

  function do_ajax_form_reserva_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_reserva_cancel_insert

  function do_ajax_form_reserva_cancel_update(iSeqVert)
  {
    do_ajax_form_reserva_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_reserva_cancel_update

  function do_ajax_form_reserva_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_reserva_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_reserva_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_reserva_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_reserva_table_refresh_cb);
  } //  do_ajax_form_reserva_table_refresh

  function do_ajax_form_reserva_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scQSInit = false;
    scAjaxAlert(do_ajax_form_reserva_table_refresh_cb_after_alert);
  } // do_ajax_form_reserva_table_refresh_cb
  function do_ajax_form_reserva_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_reserva_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_reserva_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_reserva_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_id_ = scAjaxGetFieldText("id_" + iNumLinha);
    var var_dni_ = scAjaxGetFieldText("dni_" + iNumLinha);
    var var_numserie_ = scAjaxGetFieldText("numserie_" + iNumLinha);
    var var_comienzo_ = scAjaxGetFieldText("comienzo_" + iNumLinha);
    var var_fin_ = scAjaxGetFieldText("fin_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_reserva_submit_form(var_id_, var_dni_, var_numserie_, var_comienzo_, var_fin_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_reserva_submit_form_cb);
  } // do_ajax_form_reserva_submit_form

  function do_ajax_form_reserva_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("dni_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("numserie_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("comienzo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("fin_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_reserva_submit_form_cb_after_alert);
  } // do_ajax_form_reserva_submit_form_cb
  function do_ajax_form_reserva_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_reserva_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_reserva_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_reserva_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("dni_" + iNavForm);
      scAjaxHideErrorDisplay("numserie_" + iNavForm);
      scAjaxHideErrorDisplay("comienzo_" + iNavForm);
      scAjaxHideErrorDisplay("fin_" + iNavForm);
    }
    var var_id_ = document.F2.id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_reserva_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_reserva_navigate_form_cb);
  } // do_ajax_form_reserva_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_reserva']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_reserva_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_reserva_navigate_form_cb_after_alert);
  } // do_ajax_form_reserva_navigate_form_cb
  function do_ajax_form_reserva_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_reserva_navigate_form_cb_after_alert
  function sc_hide_form_reserva_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "dni_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "numserie_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "comienzo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "fin_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["dni_" + iNumLinha] = {"label": "DNI<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["numserie_" + iNumLinha] = {"label": "Num Serie<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["comienzo_" + iNumLinha] = {"label": "Comienzo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["fin_" + iNumLinha] = {"label": "Fin<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["id_"][iNumLinha] = "id_" + iNumLinha;
    ajax_field_mult["dni_"][iNumLinha] = "dni_" + iNumLinha;
    ajax_field_mult["numserie_"][iNumLinha] = "numserie_" + iNumLinha;
    ajax_field_mult["comienzo_"][iNumLinha] = "comienzo_" + iNumLinha;
    ajax_field_mult["fin_"][iNumLinha] = "fin_" + iNumLinha;
    ajax_field_id["id_" + iNumLinha] = new Array("hidden_field_label_id_", "hidden_field_data_id_" + iNumLinha);
    ajax_field_id["dni_" + iNumLinha] = new Array("hidden_field_label_dni_", "hidden_field_data_dni_" + iNumLinha);
    ajax_field_id["numserie_" + iNumLinha] = new Array("hidden_field_label_numserie_", "hidden_field_data_numserie_" + iNumLinha);
    ajax_field_id["comienzo_" + iNumLinha] = new Array("hidden_field_label_comienzo_", "hidden_field_data_comienzo_" + iNumLinha);
    ajax_field_id["fin_" + iNumLinha] = new Array("hidden_field_label_fin_", "hidden_field_data_fin_" + iNumLinha);
    ajax_error_count["id_" + iNumLinha] = "off";
    ajax_error_count["dni_" + iNumLinha] = "off";
    ajax_error_count["numserie_" + iNumLinha] = "off";
    ajax_error_count["comienzo_" + iNumLinha] = "off";
    ajax_error_count["fin_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["id_" + iNumLinha] = "on";
    ajax_read_only["dni_" + iNumLinha] = "off";
    ajax_read_only["numserie_" + iNumLinha] = "off";
    ajax_read_only["comienzo_" + iNumLinha] = "off";
    ajax_read_only["fin_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["id_" + iNumLinha] = "on";
    ajax_read_only["dni_" + iNumLinha] = "on";
    ajax_read_only["numserie_" + iNumLinha] = "on";
    ajax_read_only["comienzo_" + iNumLinha] = "on";
    ajax_read_only["fin_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["dni_" + iNumLinha] = null;
    ajax_error_list["numserie_" + iNumLinha] = null;
    ajax_error_list["comienzo_" + iNumLinha] = null;
    ajax_error_list["fin_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["dni_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["dni_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["dni_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["dni_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["dni_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["numserie_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["numserie_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["numserie_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["numserie_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["numserie_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["comienzo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["comienzo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["comienzo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["comienzo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["comienzo_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["fin_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fin_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fin_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fin_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fin_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['dni_'])) ? $this->nmgp_cmp_readonly['dni_'] : 'off';
?>
    scAjaxFieldRead("dni_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['numserie_'])) ? $this->nmgp_cmp_readonly['numserie_'] : 'off';
?>
    scAjaxFieldRead("numserie_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['comienzo_'])) ? $this->nmgp_cmp_readonly['comienzo_'] : 'off';
?>
    scAjaxFieldRead("comienzo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fin_'])) ? $this->nmgp_cmp_readonly['fin_'] : 'off';
?>
    scAjaxFieldRead("fin_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("id_" + iSeq, "on");
    scAjaxFieldRead("dni_" + iSeq, "on");
    scAjaxFieldRead("numserie_" + iSeq, "on");
    scAjaxFieldRead("comienzo_" + iSeq, "on");
    scAjaxFieldRead("fin_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_" + iRow] || "on" == ajax_error_count["dni_" + iRow] || "on" == ajax_error_count["numserie_" + iRow] || "on" == ajax_error_count["comienzo_" + iRow] || "on" == ajax_error_count["fin_" + iRow]))
    {
      ...
      $("#hidden_field_data_dni_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_numserie_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_comienzo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_fin_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_" + iRow] && "off" == ajax_error_count["dni_" + iRow] && "off" == ajax_error_count["numserie_" + iRow] && "off" == ajax_error_count["comienzo_" + iRow] && "off" == ajax_error_count["fin_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_" + iRow] = "off";
        ajax_error_count["dni_" + iRow] = "off";
        ajax_error_count["numserie_" + iRow] = "off";
        ajax_error_count["comienzo_" + iRow] = "off";
        ajax_error_count["fin_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_dni_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_numserie_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_comienzo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_fin_" + iRow).removeClass("scFormErrorLine");
    }
  }
