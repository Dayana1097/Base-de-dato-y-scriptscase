<?php  
  ...
  session_start() ;
  class grid_peliculas_form_teste
  {
  function grid_peliculas_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_peliculas</FONT></B> 
<br> 
<br> 
...
<input type=submit value="grid_peliculas"> 
</form> 
...
<?php
  ...
  $frm_teste = new grid_peliculas_form_teste();
  $frm_teste->grid_peliculas_teste();
?>
