...
<?php
   ...
   $Ord_Cmp = new grid_equipos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_equipos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_equipos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_equipos']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["numserie"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_equipos']['labels']["numserie"])) ? $_SESSION['sc_session'][$sc_init]['grid_equipos']['labels']["numserie"] : "Num Serie";
   $tab_ger_campos['nombre'] = "on";
   $tab_def_campos['nombre'] = "Nombre";
   $tab_labels["nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_equipos']['labels']["nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_equipos']['labels']["nombre"] : "Nombre";
   $tab_ger_campos['facultad'] = "on";
   $tab_def_campos['facultad'] = "Facultad";
   $tab_labels["facultad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_equipos']['labels']["facultad"])) ? $_SESSION['sc_session'][$sc_init]['grid_equipos']['labels']["facultad"] : "Facultad";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_equipos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_equipos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_equipos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_equipos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_equipos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_equipos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_equipos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_equipos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_equipos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_equipos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_equipos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_equipos']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_equipos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_equipos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_equipos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
