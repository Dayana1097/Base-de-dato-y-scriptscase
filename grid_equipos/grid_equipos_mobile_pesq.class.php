...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_numserie_cond" name="numserie_cond" onChange="nm_campos_between(document.getElementById('id_vis_numserie'), this, 'numserie')">
