<?php  
  ...
  session_start() ;
  class grid_cajas_form_teste
  {
  function grid_cajas_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_cajas</FONT></B> 
<br> 
<br> 
...
<input type=submit value="grid_cajas"> 
</form> 
...
<?php
  ...
  $frm_teste = new grid_cajas_form_teste();
  $frm_teste->grid_cajas_teste();
?>
