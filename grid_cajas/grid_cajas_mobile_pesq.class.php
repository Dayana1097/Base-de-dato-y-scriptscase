...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "valor";$Nm_numeric[] = "almacen";$Nm_numeric[] = "valor";$Nm_numeric[] = "almacen";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_almacen_cond" name="almacen_cond" onChange="nm_campos_between(document.getElementById('id_vis_almacen'), this, 'almacen')">
      ...
      <br><span id="id_hide_almacen"  <?php echo $str_hide_almacen?>><INPUT  type="text" id="SC_almacen" name="almacen" value="<?php echo NM_encode_input($almacen) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_numreferencia_cond" name="numreferencia_cond" onChange="nm_campos_between(document.getElementById('id_vis_numreferencia'), this, 'numreferencia')">
      ...
      <br><span id="id_hide_numreferencia"  <?php echo $str_hide_numreferencia?>><?php
      if ($numreferencia != "")
      {
      $numreferencia_look = substr($this->Db->qstr($numreferencia), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_contenido_cond" name="contenido_cond" onChange="nm_campos_between(document.getElementById('id_vis_contenido'), this, 'contenido')">
      ...
      <br><span id="id_hide_contenido"  <?php echo $str_hide_contenido?>><?php
      if ($contenido != "")
      {
      $contenido_look = substr($this->Db->qstr($contenido), 1, -1); 
      $nmgp_def_dados = array(); 
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      ...
      <br><span id="id_hide_valor"  <?php echo $str_hide_valor?>><INPUT  type="text" id="SC_valor" name="valor" value="<?php echo NM_encode_input($valor) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
