<?php  
  ...
  session_start() ;
  class form_cientificos_form_teste
  {
   function form_cientificos_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_cientificos/img";
...
<?php
  ...
  $frm_teste = new form_cientificos_form_teste();
  $frm_teste->form_cientificos_teste();
?>
