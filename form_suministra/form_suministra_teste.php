<?php  
  ...
  session_start() ;
  class form_suministra_form_teste
  {
   function form_suministra_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_suministra/img";
...
<?php
  ...
  $frm_teste = new form_suministra_form_teste();
  $frm_teste->form_suministra_teste();
?>
