...
$old_error_handler = set_error_handler("form_suministra_scriptcase_error_handler");

function form_suministra_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_suministra']['contr_erro']) && $_SESSION['scriptcase']['form_suministra']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_suministra->contr_form_suministra->Apl_com_erro = true;
            if ($inicial_form_suministra->contr_form_suministra->NM_ajax_flag)
            {
                $inicial_form_suministra->contr_form_suministra->NM_ajax_info['errList']['geral_form_suministra'][] = $msg;
                return;
            }
            form_suministra_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_suministra_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_suministra'])  && '' != $_SESSION['scriptcase']['error_icon']['form_suministra'])  ? $_SESSION['scriptcase']['error_icon']['form_suministra']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_suministra']) && '' != $_SESSION['scriptcase']['error_span_title']['form_suministra']) ? $_SESSION['scriptcase']['error_span_title']['form_suministra'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_suministra']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_suministra']) ? $_SESSION['scriptcase']['error_icon_title']['form_suministra'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['form_suministra']['error_buffer'] .= ob_get_flush();
}
