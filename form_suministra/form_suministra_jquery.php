...
function scEventControl_init(iSeqRow) {
  ...
  scEventControl_data["codigopieza_" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
  scEventControl_data["idproveedor_" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
}
...
function scEventControl_active(iSeqRow) {
  ...
  if (scEventControl_data["codigopieza_" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["codigopieza_" + iSeqRow]["change"]) {
    return true;
  }
  if (scEventControl_data["idproveedor_" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["idproveedor_" + iSeqRow]["change"]) {
    return true;
  }
  return false;
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_precio_' + iSeqRow).bind('blur', function() { sc_form_suministra_precio__onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_suministra_precio__onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_suministra_precio__onfocus(this, iSeqRow) });
  $('#id_sc_field_codigopieza_' + iSeqRow).bind('blur', function() { sc_form_suministra_codigopieza__onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_suministra_codigopieza__onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_suministra_codigopieza__onfocus(this, iSeqRow) });
  $('#id_sc_field_idproveedor_' + iSeqRow).bind('blur', function() { sc_form_suministra_idproveedor__onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_suministra_idproveedor__onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_suministra_idproveedor__onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_suministra_precio__onblur(oThis, iSeqRow) {
  do_ajax_form_suministra_validate_precio_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_suministra_precio__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_suministra_precio__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_suministra_codigopieza__onblur(oThis, iSeqRow) {
  do_ajax_form_suministra_validate_codigopieza_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_suministra_codigopieza__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_suministra_codigopieza__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_suministra_idproveedor__onblur(oThis, iSeqRow) {
  do_ajax_form_suministra_validate_idproveedor_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_suministra_idproveedor__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_suministra_idproveedor__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}
...
function displayChange_block_0(status) {
	...
	displayChange_field("codigopieza_", "", status);
	displayChange_field("idproveedor_", "", status);
}

function displayChange_row(row, status) {
	displayChange_field_precio_(row, status);
	displayChange_field_codigopieza_(row, status);
	displayChange_field_idproveedor_(row, status);
}
...
function displayChange_field(field, row, status) {
	...
	if ("codigopieza_" == field) {
		displayChange_field_codigopieza_(row, status);
	}
	if ("idproveedor_" == field) {
		displayChange_field_idproveedor_(row, status);
	}
}
...
function displayChange_field_codigopieza_(row, status) {
}

function displayChange_field_idproveedor_(row, status) {
}
...
function scHidePage(pageNo) {
	$("#id_form_suministra_form" + pageNo).hide();
}
