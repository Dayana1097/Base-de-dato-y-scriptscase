  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_suministra" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_suministra_form();
	}

  // ---------- Validate precio_
  function do_ajax_form_suministra_validate_precio_(iNumLinha)
  {
    var nomeCampo_precio_ = "precio_" + iNumLinha;
    var var_precio_ = scAjaxGetFieldText(nomeCampo_precio_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_suministra_validate_precio_(var_precio_, iNumLinha, var_script_case_init, do_ajax_form_suministra_validate_precio__cb);
  } // do_ajax_form_suministra_validate_precio_

  function do_ajax_form_suministra_validate_precio__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_suministra_validate_precio__cb

  // ---------- Validate codigopieza_
  function do_ajax_form_suministra_validate_codigopieza_(iNumLinha)
  {
    var nomeCampo_codigopieza_ = "codigopieza_" + iNumLinha;
    var var_codigopieza_ = scAjaxGetFieldText(nomeCampo_codigopieza_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_suministra_validate_codigopieza_(var_codigopieza_, iNumLinha, var_script_case_init, do_ajax_form_suministra_validate_codigopieza__cb);
  } // do_ajax_form_suministra_validate_codigopieza_

  function do_ajax_form_suministra_validate_codigopieza__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "codigopieza_" + iLineNumber;
    }
    else
    {
      sFieldValid = "codigopieza_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "codigopieza_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "codigopieza_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_suministra_validate_codigopieza__cb

  // ---------- Validate idproveedor_
  function do_ajax_form_suministra_validate_idproveedor_(iNumLinha)
  {
    var nomeCampo_idproveedor_ = "idproveedor_" + iNumLinha;
    var var_idproveedor_ = scAjaxGetFieldText(nomeCampo_idproveedor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_suministra_validate_idproveedor_(var_idproveedor_, iNumLinha, var_script_case_init, do_ajax_form_suministra_validate_idproveedor__cb);
  } // do_ajax_form_suministra_validate_idproveedor_

  function do_ajax_form_suministra_validate_idproveedor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idproveedor_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idproveedor_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idproveedor_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idproveedor_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_suministra_validate_idproveedor__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_suministra_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_suministra_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_suministra_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_suministra_add_new_line_cb);
  } // do_ajax_form_suministra_add_new_line

  function do_ajax_form_suministra_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_suministra_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_suministra_backup_line(iNumLinha)
  {
    var var_precio_ = scAjaxGetFieldText("precio_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_suministra_backup_line(var_precio_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_suministra_backup_line_cb);
  } // do_ajax_form_suministra_backup_line

  function do_ajax_form_suministra_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_suministra_backup_line_cb

  function do_ajax_form_suministra_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_suministra_cancel_insert

  function do_ajax_form_suministra_cancel_update(iSeqVert)
  {
    do_ajax_form_suministra_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_suministra_cancel_update

  function do_ajax_form_suministra_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_suministra_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_suministra_table_refresh()
  {
    var var_precio_ = document.F2.precio_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_suministra_table_refresh(var_precio_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_suministra_table_refresh_cb);
  } //  do_ajax_form_suministra_table_refresh

  function do_ajax_form_suministra_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.precio_.value = scAjaxGetKeyValue("precio_");
    ...
    scQSInit = false;
    scAjaxAlert(do_ajax_form_suministra_table_refresh_cb_after_alert);
  } // do_ajax_form_suministra_table_refresh_cb
  function do_ajax_form_suministra_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_suministra_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_suministra_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_suministra_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_precio_ = scAjaxGetFieldText("precio_" + iNumLinha);
    var var_codigopieza_ = scAjaxGetFieldText("codigopieza_" + iNumLinha);
    var var_idproveedor_ = scAjaxGetFieldText("idproveedor_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_suministra_submit_form(var_precio_, var_codigopieza_, var_idproveedor_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_suministra_submit_form_cb);
  } // do_ajax_form_suministra_submit_form

  function do_ajax_form_suministra_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("codigopieza_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("idproveedor_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_suministra_submit_form_cb_after_alert);
  } // do_ajax_form_suministra_submit_form_cb
  function do_ajax_form_suministra_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_suministra_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_suministra_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_suministra_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("codigopieza_" + iNavForm);
      scAjaxHideErrorDisplay("idproveedor_" + iNavForm);
    }
    var var_precio_ = document.F2.precio_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_suministra_navigate_form(var_precio_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_suministra_navigate_form_cb);
  } // do_ajax_form_suministra_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_suministra']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_suministra_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.precio_.value = scAjaxGetKeyValue("precio_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_suministra_navigate_form_cb_after_alert);
  } // do_ajax_form_suministra_navigate_form_cb
  function do_ajax_form_suministra_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_suministra_navigate_form_cb_after_alert
  function sc_hide_form_suministra_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "codigopieza_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idproveedor_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["precio_" + iNumLinha] = {"label": "Precio<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["codigopieza_" + iNumLinha] = {"label": "Codigo Pieza<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["idproveedor_" + iNumLinha] = {"label": "Id Proveedor<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["precio_"][iNumLinha] = "precio_" + iNumLinha;
    ajax_field_mult["codigopieza_"][iNumLinha] = "codigopieza_" + iNumLinha;
    ajax_field_mult["idproveedor_"][iNumLinha] = "idproveedor_" + iNumLinha;
    ajax_field_id["precio_" + iNumLinha] = new Array("hidden_field_label_precio_", "hidden_field_data_precio_" + iNumLinha);
    ajax_field_id["codigopieza_" + iNumLinha] = new Array("hidden_field_label_codigopieza_", "hidden_field_data_codigopieza_" + iNumLinha);
    ajax_field_id["idproveedor_" + iNumLinha] = new Array("hidden_field_label_idproveedor_", "hidden_field_data_idproveedor_" + iNumLinha);
    ajax_error_count["precio_" + iNumLinha] = "off";
    ajax_error_count["codigopieza_" + iNumLinha] = "off";
    ajax_error_count["idproveedor_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["precio_" + iNumLinha] = "on";
    ajax_read_only["codigopieza_" + iNumLinha] = "off";
    ajax_read_only["idproveedor_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["precio_" + iNumLinha] = "on";
    ajax_read_only["codigopieza_" + iNumLinha] = "on";
    ajax_read_only["idproveedor_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["codigopieza_" + iNumLinha] = null;
    ajax_error_list["idproveedor_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "precio_": new Array(),
    "codigopieza_": new Array(),
    "idproveedor_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["codigopieza_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["codigopieza_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["codigopieza_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["codigopieza_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["codigopieza_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["idproveedor_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idproveedor_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idproveedor_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idproveedor_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idproveedor_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['precio_'])) ? $this->nmgp_cmp_readonly['precio_'] : 'on';
?>
    scAjaxFieldRead("precio_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['codigopieza_'])) ? $this->nmgp_cmp_readonly['codigopieza_'] : 'off';
?>
    scAjaxFieldRead("codigopieza_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idproveedor_'])) ? $this->nmgp_cmp_readonly['idproveedor_'] : 'off';
?>
    scAjaxFieldRead("idproveedor_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("precio_" + iSeq, "on");
    scAjaxFieldRead("codigopieza_" + iSeq, "on");
    scAjaxFieldRead("idproveedor_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["precio_" + iRow] || "on" == ajax_error_count["codigopieza_" + iRow] || "on" == ajax_error_count["idproveedor_" + iRow]))
    {
      ...
      $("#hidden_field_data_codigopieza_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idproveedor_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["precio_" + iRow] && "off" == ajax_error_count["codigopieza_" + iRow] && "off" == ajax_error_count["idproveedor_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["precio_" + iRow] = "off";
        ajax_error_count["codigopieza_" + iRow] = "off";
        ajax_error_count["idproveedor_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_codigopieza_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_idproveedor_" + iRow).removeClass("scFormErrorLine");
    }
  }
