...
function scEventControl_init(iSeqRow) {
  ...
  scEventControl_data["presupuesto_" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
}
...
function scEventControl_active(iSeqRow) {
  ...
  if (scEventControl_data["presupuesto_" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["presupuesto_" + iSeqRow]["change"]) {
    return true;
  }
  return false;
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_codigo_' + iSeqRow).bind('blur', function() { sc_form_departamentos_codigo__onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_departamentos_codigo__onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_departamentos_codigo__onfocus(this, iSeqRow) });
  $('#id_sc_field_nombre_' + iSeqRow).bind('blur', function() { sc_form_departamentos_nombre__onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_departamentos_nombre__onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_departamentos_nombre__onfocus(this, iSeqRow) });
  $('#id_sc_field_presupuesto_' + iSeqRow).bind('blur', function() { sc_form_departamentos_presupuesto__onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_departamentos_presupuesto__onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_departamentos_presupuesto__onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_departamentos_codigo__onblur(oThis, iSeqRow) {
  do_ajax_form_departamentos_validate_codigo_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_departamentos_codigo__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_departamentos_codigo__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_departamentos_nombre__onblur(oThis, iSeqRow) {
  do_ajax_form_departamentos_validate_nombre_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_departamentos_nombre__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_departamentos_nombre__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_departamentos_presupuesto__onblur(oThis, iSeqRow) {
  do_ajax_form_departamentos_validate_presupuesto_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_departamentos_presupuesto__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_departamentos_presupuesto__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}
...
function displayChange_field_presupuesto_(row, status) {
}
...
function scHidePage(pageNo) {
	$("#id_form_departamentos_form" + pageNo).hide();
}
