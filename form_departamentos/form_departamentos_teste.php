<?php  
  ...
  session_start() ;
  class form_departamentos_form_teste
  {
   function form_departamentos_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_departamentos/img";
...
<?php
  ...
  $frm_teste = new form_departamentos_form_teste();
  $frm_teste->form_departamentos_teste();
?>
