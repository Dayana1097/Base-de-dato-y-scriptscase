<?php  
  ...
  session_start() ;
  class form_almacenes_form_teste
  {
   function form_almacenes_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_almacenes/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_almacenes</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="form_almacenes"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_almacenes_form_teste();
  $frm_teste->form_almacenes_teste();
?>
