  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_almacenes_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_almacenes_mob_form();
	}

  // ---------- Validate codigo
  function do_ajax_form_almacenes_mob_validate_codigo()
  {
    var nomeCampo_codigo = "codigo";
    var var_codigo = scAjaxGetFieldText(nomeCampo_codigo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_almacenes_mob_validate_codigo(var_codigo, var_script_case_init, do_ajax_form_almacenes_mob_validate_codigo_cb);
  } // do_ajax_form_almacenes_mob_validate_codigo

  function do_ajax_form_almacenes_mob_validate_codigo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_almacenes_mob_validate_codigo_cb

  // ---------- Validate lugar
  function do_ajax_form_almacenes_mob_validate_lugar()
  {
    var nomeCampo_lugar = "lugar";
    var var_lugar = scAjaxGetFieldText(nomeCampo_lugar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_almacenes_mob_validate_lugar(var_lugar, var_script_case_init, do_ajax_form_almacenes_mob_validate_lugar_cb);
  } // do_ajax_form_almacenes_mob_validate_lugar

  function do_ajax_form_almacenes_mob_validate_lugar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "lugar";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_almacenes_mob_validate_lugar_cb

  // ---------- Validate capacidad
  function do_ajax_form_almacenes_mob_validate_capacidad()
  {
    var nomeCampo_capacidad = "capacidad";
    var var_capacidad = scAjaxGetFieldText(nomeCampo_capacidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_almacenes_mob_validate_capacidad(var_capacidad, var_script_case_init, do_ajax_form_almacenes_mob_validate_capacidad_cb);
  } // do_ajax_form_almacenes_mob_validate_capacidad

  function do_ajax_form_almacenes_mob_validate_capacidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "capacidad";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_almacenes_mob_validate_capacidad_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_almacenes_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_almacenes_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_codigo = scAjaxGetFieldText("codigo");
    var var_lugar = scAjaxGetFieldText("lugar");
    var var_capacidad = scAjaxGetFieldText("capacidad");
    ...
    scAjaxProcOn();
    x_ajax_form_almacenes_mob_submit_form(var_codigo, var_lugar, var_capacidad, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_almacenes_mob_submit_form_cb);
  } // do_ajax_form_almacenes_mob_submit_form

  function do_ajax_form_almacenes_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("lugar");
      scAjaxHideErrorDisplay("capacidad");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_almacenes_mob_submit_form_cb_after_alert);
  } // do_ajax_form_almacenes_mob_submit_form_cb
  function do_ajax_form_almacenes_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_almacenes_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_almacenes_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_almacenes_mob_navigate_form(var_codigo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_almacenes_mob_navigate_form_cb);
  } // do_ajax_form_almacenes_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_almacenes_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_almacenes_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_almacenes_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_almacenes_mob_navigate_form_cb
  function do_ajax_form_almacenes_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_almacenes_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_almacenes_mob_navigate_form_cb_after_alert
  function sc_hide_form_almacenes_mob_form()
  {
  ...
  ajax_field_list[1] = "lugar";
  ajax_field_list[2] = "capacidad";
  ...
  var ajax_error_list = {
    ...
    "lugar": {"label": "Lugar", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "capacidad": {"label": "Capacidad", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["lugar"][1] = "lugar";
  ajax_field_mult["capacidad"][1] = "capacidad";

  var ajax_field_id = {
    "codigo": new Array("hidden_field_label_codigo", "hidden_field_data_codigo"),
    "lugar": new Array("hidden_field_label_lugar", "hidden_field_data_lugar"),
    "capacidad": new Array("hidden_field_label_capacidad", "hidden_field_data_capacidad")
  };
