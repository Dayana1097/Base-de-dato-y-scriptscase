  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_almacenes" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_almacenes_form();
	}

  // ---------- Validate codigo
  function do_ajax_form_almacenes_validate_codigo()
  {
    var nomeCampo_codigo = "codigo";
    var var_codigo = scAjaxGetFieldText(nomeCampo_codigo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_almacenes_validate_codigo(var_codigo, var_script_case_init, do_ajax_form_almacenes_validate_codigo_cb);
  } // do_ajax_form_almacenes_validate_codigo

  function do_ajax_form_almacenes_validate_codigo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_almacenes_validate_codigo_cb

  // ---------- Validate lugar
  function do_ajax_form_almacenes_validate_lugar()
  {
    var nomeCampo_lugar = "lugar";
    var var_lugar = scAjaxGetFieldText(nomeCampo_lugar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_almacenes_validate_lugar(var_lugar, var_script_case_init, do_ajax_form_almacenes_validate_lugar_cb);
  } // do_ajax_form_almacenes_validate_lugar

  function do_ajax_form_almacenes_validate_lugar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "lugar";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_almacenes_validate_lugar_cb

  // ---------- Validate capacidad
  function do_ajax_form_almacenes_validate_capacidad()
  {
    var nomeCampo_capacidad = "capacidad";
    var var_capacidad = scAjaxGetFieldText(nomeCampo_capacidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_almacenes_validate_capacidad(var_capacidad, var_script_case_init, do_ajax_form_almacenes_validate_capacidad_cb);
  } // do_ajax_form_almacenes_validate_capacidad

  function do_ajax_form_almacenes_validate_capacidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_almacenes_validate_capacidad_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_almacenes_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_almacenes_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_almacenes_submit_form(var_codigo, var_lugar, var_capacidad, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_almacenes_submit_form_cb);
  } // do_ajax_form_almacenes_submit_form

  function do_ajax_form_almacenes_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_almacenes_submit_form_cb_after_alert);
  } // do_ajax_form_almacenes_submit_form_cb
  function do_ajax_form_almacenes_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_almacenes_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_almacenes_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_almacenes_navigate_form(var_codigo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_almacenes_navigate_form_cb);
  } // do_ajax_form_almacenes_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_almacenes']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_almacenes_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_almacenes_navigate_form_cb_after_alert);
  } // do_ajax_form_almacenes_navigate_form_cb
  function do_ajax_form_almacenes_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_almacenes_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_almacenes_navigate_form_cb_after_alert
  function sc_hide_form_almacenes_form()
  {
