...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "departamento";$Nm_numeric[] = "departamento";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_departamento_cond" name="departamento_cond" onChange="nm_campos_between(document.getElementById('id_vis_departamento'), this, 'departamento')">
      ...
      <br><span id="id_hide_departamento"  <?php echo $str_hide_departamento?>><INPUT  type="text" id="SC_departamento" name="departamento" value="<?php echo NM_encode_input($departamento) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_dni_cond" name="dni_cond" onChange="nm_campos_between(document.getElementById('id_vis_dni'), this, 'dni')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_apellidos_cond" name="apellidos_cond" onChange="nm_campos_between(document.getElementById('id_vis_apellidos'), this, 'apellidos')">
      ...
      <br><span id="id_hide_apellidos"  <?php echo $str_hide_apellidos?>><?php
      if ($apellidos != "")
      {
      $apellidos_look = substr($this->Db->qstr($apellidos), 1, -1); 
      $nmgp_def_dados = array(); 
