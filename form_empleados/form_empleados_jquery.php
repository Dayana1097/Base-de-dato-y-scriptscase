...
function scEventControl_init(iSeqRow) {
  ...
  scEventControl_data["apellidos_" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
...
function scEventControl_active(iSeqRow) {
  ...
  if (scEventControl_data["apellidos_" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["apellidos_" + iSeqRow]["change"]) {
    return true;
  }
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_dni_' + iSeqRow).bind('blur', function() { sc_form_empleados_dni__onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_form_empleados_dni__onchange(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_empleados_dni__onfocus(this, iSeqRow) });
  $('#id_sc_field_nombre_' + iSeqRow).bind('blur', function() { sc_form_empleados_nombre__onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_empleados_nombre__onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_empleados_nombre__onfocus(this, iSeqRow) });
  $('#id_sc_field_apellidos_' + iSeqRow).bind('blur', function() { sc_form_empleados_apellidos__onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_empleados_apellidos__onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_empleados_apellidos__onfocus(this, iSeqRow) });
  $('#id_sc_field_departamento_' + iSeqRow).bind('blur', function() { sc_form_empleados_departamento__onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_empleados_departamento__onchange(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_empleados_departamento__onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_empleados_dni__onblur(oThis, iSeqRow) {
  do_ajax_form_empleados_validate_dni_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_empleados_dni__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_empleados_dni__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_empleados_nombre__onblur(oThis, iSeqRow) {
  do_ajax_form_empleados_validate_nombre_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_empleados_nombre__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_empleados_nombre__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_empleados_apellidos__onblur(oThis, iSeqRow) {
  do_ajax_form_empleados_validate_apellidos_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_empleados_apellidos__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_empleados_apellidos__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_empleados_departamento__onblur(oThis, iSeqRow) {
  do_ajax_form_empleados_validate_departamento_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_empleados_departamento__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_empleados_departamento__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}
...
function displayChange_block_0(status) {
	...
	displayChange_field("apellidos_", "", status);
...
function displayChange_row(row, status) {
	...
	displayChange_field_apellidos_(row, status);
...
function displayChange_field_apellidos_(row, status) {
}
