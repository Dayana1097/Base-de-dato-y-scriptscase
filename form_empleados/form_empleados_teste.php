<?php  
  ...
  session_start() ;
  class form_empleados_form_teste
  {
   function form_empleados_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_empleados/img";
...
<?php
  ...
  $frm_teste = new form_empleados_form_teste();
  $frm_teste->form_empleados_teste();
?>
