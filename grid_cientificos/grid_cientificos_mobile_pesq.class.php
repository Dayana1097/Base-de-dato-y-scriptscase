...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_nomapls_cond" name="nomapls_cond" onChange="nm_campos_between(document.getElementById('id_vis_nomapls'), this, 'nomapls')">
      ...
      <br><span id="id_hide_nomapls"  <?php echo $str_hide_nomapls?>><?php
      if ($nomapls != "")
      {
      $nomapls_look = substr($this->Db->qstr($nomapls), 1, -1); 
      $nmgp_def_dados = array(); 
