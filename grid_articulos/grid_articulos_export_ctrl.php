<?php
@session_start() ;
$_SESSION['scriptcase']['grid_articulos']['sc_process_barr'] = true;
require_once('../grid_articulos/index.php');
unset($_SESSION['scriptcase']['grid_articulos']['sc_process_barr']);
$ExportCtrl = new grid_articulos_export_control;
$ExportCtrl->Export_barr();

class grid_articulos_export_control
{
