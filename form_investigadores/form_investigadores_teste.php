<?php  
  ...
  session_start() ;
  class form_investigadores_form_teste
  {
   function form_investigadores_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_investigadores/img";
...
<?php
  ...
  $frm_teste = new form_investigadores_form_teste();
  $frm_teste->form_investigadores_teste();
?>
