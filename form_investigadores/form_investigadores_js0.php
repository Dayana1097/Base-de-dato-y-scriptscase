<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="dni_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['dni_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_investigadores"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function scForm_inline_submit(y, z) {
	Nm_Proc_Atualiz = true;
	do_ajax_form_investigadores_submit_form(y, z);
