...
<html>
    <head>
        ...
        <link rel="stylesheet"  href="<?php echo $_SESSION["scriptcase"]["Almacenes"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.css" />
        <link rel="stylesheet"  href="<?php echo $this->url_css; ?>Sc9_SweetAmour/Sc9_SweetAmour_menuMobile.css" />
        <link rel="stylesheet"  href="<?php echo $this->url_css; ?>Sc9_SweetAmour/Sc9_SweetAmour_menuMobile<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" />
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["Almacenes"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.js"></script>
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["Almacenes"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.js"></script>
    <style>
    <?php
    if(isset($Almacenes_menuData["data"]) && is_array($Almacenes_menuData["data"]) && !empty($Almacenes_menuData["data"]))
    {
        foreach($Almacenes_menuData["data"] as $arr_item)
        {
    ...
    <body>
    <?php
        escreveMenuMobile($Almacenes_menuData["data"], $this->path_imag_apl);
    ?>
	<?php
