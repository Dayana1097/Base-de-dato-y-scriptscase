<?php  
  ...
  session_start() ;
  class form_articulos_1_form_teste
  {
   function form_articulos_1_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_articulos_1/img";
...
<?php
  ...
  $frm_teste = new form_articulos_1_form_teste();
  $frm_teste->form_articulos_1_teste();
?>
