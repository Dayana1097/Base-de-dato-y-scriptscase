  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cajas" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_cajas_form();
	}

  // ---------- Validate numreferencia_
  function do_ajax_form_cajas_validate_numreferencia_(iNumLinha)
  {
    var nomeCampo_numreferencia_ = "numreferencia_" + iNumLinha;
    var var_numreferencia_ = scAjaxGetFieldText(nomeCampo_numreferencia_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cajas_validate_numreferencia_(var_numreferencia_, iNumLinha, var_script_case_init, do_ajax_form_cajas_validate_numreferencia__cb);
  } // do_ajax_form_cajas_validate_numreferencia_

  function do_ajax_form_cajas_validate_numreferencia__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "numreferencia_" + iLineNumber;
    }
    else
    {
      sFieldValid = "numreferencia_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "numreferencia_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "numreferencia_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cajas_validate_numreferencia__cb

  // ---------- Validate contenido_
  function do_ajax_form_cajas_validate_contenido_(iNumLinha)
  {
    var nomeCampo_contenido_ = "contenido_" + iNumLinha;
    var var_contenido_ = scAjaxGetFieldText(nomeCampo_contenido_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cajas_validate_contenido_(var_contenido_, iNumLinha, var_script_case_init, do_ajax_form_cajas_validate_contenido__cb);
  } // do_ajax_form_cajas_validate_contenido_

  function do_ajax_form_cajas_validate_contenido__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "contenido_" + iLineNumber;
    }
    else
    {
      sFieldValid = "contenido_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "contenido_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "contenido_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cajas_validate_contenido__cb

  // ---------- Validate valor_
  function do_ajax_form_cajas_validate_valor_(iNumLinha)
  {
    var nomeCampo_valor_ = "valor_" + iNumLinha;
    var var_valor_ = scAjaxGetFieldText(nomeCampo_valor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cajas_validate_valor_(var_valor_, iNumLinha, var_script_case_init, do_ajax_form_cajas_validate_valor__cb);
  } // do_ajax_form_cajas_validate_valor_

  function do_ajax_form_cajas_validate_valor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "valor_" + iLineNumber;
    }
    else
    {
      sFieldValid = "valor_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "valor_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "valor_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cajas_validate_valor__cb

  // ---------- Validate almacen_
  function do_ajax_form_cajas_validate_almacen_(iNumLinha)
  {
    var nomeCampo_almacen_ = "almacen_" + iNumLinha;
    var var_almacen_ = scAjaxGetFieldText(nomeCampo_almacen_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cajas_validate_almacen_(var_almacen_, iNumLinha, var_script_case_init, do_ajax_form_cajas_validate_almacen__cb);
  } // do_ajax_form_cajas_validate_almacen_

  function do_ajax_form_cajas_validate_almacen__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "almacen_" + iLineNumber;
    }
    else
    {
      sFieldValid = "almacen_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "almacen_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "almacen_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cajas_validate_almacen__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_cajas_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_cajas_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_cajas_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_cajas_add_new_line_cb);
  } // do_ajax_form_cajas_add_new_line

  function do_ajax_form_cajas_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_cajas_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_cajas_backup_line(iNumLinha)
  {
    var var_numreferencia_ = scAjaxGetFieldText("numreferencia_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cajas_backup_line(var_numreferencia_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_cajas_backup_line_cb);
  } // do_ajax_form_cajas_backup_line

  function do_ajax_form_cajas_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_cajas_backup_line_cb

  function do_ajax_form_cajas_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_cajas_cancel_insert

  function do_ajax_form_cajas_cancel_update(iSeqVert)
  {
    do_ajax_form_cajas_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_cajas_cancel_update

  function do_ajax_form_cajas_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_cajas_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_cajas_table_refresh()
  {
    var var_numreferencia_ = document.F2.numreferencia_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_cajas_table_refresh(var_numreferencia_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cajas_table_refresh_cb);
  } //  do_ajax_form_cajas_table_refresh

  function do_ajax_form_cajas_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.numreferencia_.value = scAjaxGetKeyValue("numreferencia_");
    ...
    scQSInit = false;
    scAjaxAlert(do_ajax_form_cajas_table_refresh_cb_after_alert);
  } // do_ajax_form_cajas_table_refresh_cb
  function do_ajax_form_cajas_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_cajas_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_cajas_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_cajas_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_numreferencia_ = scAjaxGetFieldText("numreferencia_" + iNumLinha);
    var var_contenido_ = scAjaxGetFieldText("contenido_" + iNumLinha);
    var var_valor_ = scAjaxGetFieldText("valor_" + iNumLinha);
    var var_almacen_ = scAjaxGetFieldText("almacen_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_cajas_submit_form(var_numreferencia_, var_contenido_, var_valor_, var_almacen_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_cajas_submit_form_cb);
  } // do_ajax_form_cajas_submit_form

  function do_ajax_form_cajas_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("numreferencia_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("contenido_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("valor_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("almacen_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_cajas_submit_form_cb_after_alert);
  } // do_ajax_form_cajas_submit_form_cb
  function do_ajax_form_cajas_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_cajas_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_cajas_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_cajas_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("numreferencia_" + iNavForm);
      scAjaxHideErrorDisplay("contenido_" + iNavForm);
      scAjaxHideErrorDisplay("valor_" + iNavForm);
      scAjaxHideErrorDisplay("almacen_" + iNavForm);
    }
    var var_numreferencia_ = document.F2.numreferencia_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_cajas_navigate_form(var_numreferencia_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cajas_navigate_form_cb);
  } // do_ajax_form_cajas_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cajas']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_cajas_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.numreferencia_.value = scAjaxGetKeyValue("numreferencia_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_cajas_navigate_form_cb_after_alert);
  } // do_ajax_form_cajas_navigate_form_cb
  function do_ajax_form_cajas_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_cajas_navigate_form_cb_after_alert
  function sc_hide_form_cajas_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "numreferencia_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "contenido_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "valor_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "almacen_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["numreferencia_" + iNumLinha] = {"label": "Numreferencia<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["contenido_" + iNumLinha] = {"label": "Contenido<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["valor_" + iNumLinha] = {"label": "Valor<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["almacen_" + iNumLinha] = {"label": "Almacen<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["numreferencia_"][iNumLinha] = "numreferencia_" + iNumLinha;
    ajax_field_mult["contenido_"][iNumLinha] = "contenido_" + iNumLinha;
    ajax_field_mult["valor_"][iNumLinha] = "valor_" + iNumLinha;
    ajax_field_mult["almacen_"][iNumLinha] = "almacen_" + iNumLinha;
    ajax_field_id["numreferencia_" + iNumLinha] = new Array("hidden_field_label_numreferencia_", "hidden_field_data_numreferencia_" + iNumLinha);
    ajax_field_id["contenido_" + iNumLinha] = new Array("hidden_field_label_contenido_", "hidden_field_data_contenido_" + iNumLinha);
    ajax_field_id["valor_" + iNumLinha] = new Array("hidden_field_label_valor_", "hidden_field_data_valor_" + iNumLinha);
    ajax_field_id["almacen_" + iNumLinha] = new Array("hidden_field_label_almacen_", "hidden_field_data_almacen_" + iNumLinha);
    ajax_error_count["numreferencia_" + iNumLinha] = "off";
    ajax_error_count["contenido_" + iNumLinha] = "off";
    ajax_error_count["valor_" + iNumLinha] = "off";
    ajax_error_count["almacen_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["numreferencia_" + iNumLinha] = "on";
    ajax_read_only["contenido_" + iNumLinha] = "off";
    ajax_read_only["valor_" + iNumLinha] = "off";
    ajax_read_only["almacen_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["numreferencia_" + iNumLinha] = "on";
    ajax_read_only["contenido_" + iNumLinha] = "on";
    ajax_read_only["valor_" + iNumLinha] = "on";
    ajax_read_only["almacen_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["numreferencia_" + iNumLinha] = null;
    ajax_error_list["contenido_" + iNumLinha] = null;
    ajax_error_list["valor_" + iNumLinha] = null;
    ajax_error_list["almacen_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "numreferencia_": new Array(),
    "contenido_": new Array(),
    "valor_": new Array(),
    "almacen_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["numreferencia_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["numreferencia_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["numreferencia_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["numreferencia_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["numreferencia_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["contenido_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["contenido_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["contenido_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["contenido_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["contenido_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["valor_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["valor_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["valor_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["valor_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["valor_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["almacen_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["almacen_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["almacen_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["almacen_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["almacen_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['numreferencia_'])) ? $this->nmgp_cmp_readonly['numreferencia_'] : 'on';
?>
    scAjaxFieldRead("numreferencia_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['contenido_'])) ? $this->nmgp_cmp_readonly['contenido_'] : 'off';
?>
    scAjaxFieldRead("contenido_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['valor_'])) ? $this->nmgp_cmp_readonly['valor_'] : 'off';
?>
    scAjaxFieldRead("valor_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['almacen_'])) ? $this->nmgp_cmp_readonly['almacen_'] : 'off';
?>
    scAjaxFieldRead("almacen_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("numreferencia_" + iSeq, "on");
    scAjaxFieldRead("contenido_" + iSeq, "on");
    scAjaxFieldRead("valor_" + iSeq, "on");
    scAjaxFieldRead("almacen_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["numreferencia_" + iRow] || "on" == ajax_error_count["contenido_" + iRow] || "on" == ajax_error_count["valor_" + iRow] || "on" == ajax_error_count["almacen_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_numreferencia_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_contenido_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_valor_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_almacen_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["numreferencia_" + iRow] && "off" == ajax_error_count["contenido_" + iRow] && "off" == ajax_error_count["valor_" + iRow] && "off" == ajax_error_count["almacen_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["numreferencia_" + iRow] = "off";
        ajax_error_count["contenido_" + iRow] = "off";
        ajax_error_count["valor_" + iRow] = "off";
        ajax_error_count["almacen_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_numreferencia_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_contenido_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_valor_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_almacen_" + iRow).removeClass("scFormErrorLine");
    }
  }
