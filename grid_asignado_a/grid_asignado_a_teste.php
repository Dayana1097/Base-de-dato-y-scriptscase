<?php  
  ...
  session_start() ;
  class grid_asignado_a_form_teste
  {
  function grid_asignado_a_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_asignado_a</FONT></B> 
<br> 
<br> 
...
<input type=submit value="grid_asignado_a"> 
</form> 
...
<?php
  ...
  $frm_teste = new grid_asignado_a_form_teste();
  $frm_teste->grid_asignado_a_teste();
?>
