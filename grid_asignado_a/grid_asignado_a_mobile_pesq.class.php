...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_cientifico_cond" name="cientifico_cond" onChange="nm_campos_between(document.getElementById('id_vis_cientifico'), this, 'cientifico')">
      ...
      <br><span id="id_hide_cientifico"  <?php echo $str_hide_cientifico?>><?php
      if ($cientifico != "")
      {
      $cientifico_look = substr($this->Db->qstr($cientifico), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_proyecto_cond" name="proyecto_cond" onChange="nm_campos_between(document.getElementById('id_vis_proyecto'), this, 'proyecto')">
      ...
      <br><span id="id_hide_proyecto"  <?php echo $str_hide_proyecto?>><?php
      if ($proyecto != "")
      {
      $proyecto_look = substr($this->Db->qstr($proyecto), 1, -1); 
      $nmgp_def_dados = array(); 
