<?php
@session_start() ;
$_SESSION['scriptcase']['grid_asignado_a']['sc_process_barr'] = true;
require_once('../grid_asignado_a/index.php');
unset($_SESSION['scriptcase']['grid_asignado_a']['sc_process_barr']);
$ExportCtrl = new grid_asignado_a_export_control;
$ExportCtrl->Export_barr();

class grid_asignado_a_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> asignado_a :: Excel</TITLE>
