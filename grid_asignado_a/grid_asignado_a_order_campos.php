...
<?php
   ...
   $Ord_Cmp = new grid_asignado_a_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_asignado_a_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_asignado_a']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_asignado_a']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['cientifico'] = "cientifico";
   $tab_labels["cientifico"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_asignado_a']['labels']["cientifico"])) ? $_SESSION['sc_session'][$sc_init]['grid_asignado_a']['labels']["cientifico"] : "Cientifico";
   $tab_ger_campos['proyecto'] = "on";
   $tab_def_campos['proyecto'] = "proyecto";
   $tab_labels["proyecto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_asignado_a']['labels']["proyecto"])) ? $_SESSION['sc_session'][$sc_init]['grid_asignado_a']['labels']["proyecto"] : "Proyecto";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_asignado_a']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_asignado_a']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_asignado_a']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_asignado_a']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_asignado_a']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_asignado_a']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_asignado_a']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_asignado_a']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_asignado_a']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_asignado_a_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_asignado_a']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_asignado_a']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_asignado_a']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_asignado_a']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_asignado_a']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
