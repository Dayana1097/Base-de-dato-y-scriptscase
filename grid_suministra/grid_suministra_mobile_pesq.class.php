...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "precio";$Nm_numeric[] = "codigopieza";$Nm_numeric[] = "precio";$Nm_numeric[] = "codigopieza";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_precio_cond" name="precio_cond" onChange="nm_campos_between(document.getElementById('id_vis_precio'), this, 'precio')">
      ...
      <br><span id="id_hide_precio"  <?php echo $str_hide_precio?>><INPUT  type="text" id="SC_precio" name="precio" value="<?php echo NM_encode_input($precio) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_codigopieza_cond" name="codigopieza_cond" onChange="nm_campos_between(document.getElementById('id_vis_codigopieza'), this, 'codigopieza')">
      ...
      <br><span id="id_hide_codigopieza"  <?php echo $str_hide_codigopieza?>><INPUT  type="text" id="SC_codigopieza" name="codigopieza" value="<?php echo NM_encode_input($codigopieza) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_idproveedor_cond" name="idproveedor_cond" onChange="nm_campos_between(document.getElementById('id_vis_idproveedor'), this, 'idproveedor')">
      ...
      <br><span id="id_hide_idproveedor"  <?php echo $str_hide_idproveedor?>><?php
      if ($idproveedor != "")
      {
      $idproveedor_look = substr($this->Db->qstr($idproveedor), 1, -1); 
      $nmgp_def_dados = array(); 
