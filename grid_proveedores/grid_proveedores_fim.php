...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Almacen_____grid_proveedores"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Almacen_____grid_proveedores"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_proveedores'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_proveedores']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_proveedores']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_proveedores']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_proveedores']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_proveedores']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_proveedores']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_proveedores']['embutida_filho'] as $ind => $sc_init)
          {
