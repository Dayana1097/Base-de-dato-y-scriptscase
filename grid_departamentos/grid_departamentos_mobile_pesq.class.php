...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "codigo";$Nm_numeric[] = "presupuesto";$Nm_numeric[] = "codigo";$Nm_numeric[] = "presupuesto";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_presupuesto_cond" name="presupuesto_cond" onChange="nm_campos_between(document.getElementById('id_vis_presupuesto'), this, 'presupuesto')">
      ...
      <br><span id="id_hide_presupuesto"  <?php echo $str_hide_presupuesto?>><INPUT  type="text" id="SC_presupuesto" name="presupuesto" value="<?php echo NM_encode_input($presupuesto) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
