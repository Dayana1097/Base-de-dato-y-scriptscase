...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Almacen_____grid_departamentos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Almacen_____grid_departamentos"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_departamentos'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_departamentos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_departamentos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_departamentos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_departamentos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_departamentos']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_departamentos</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_departamentos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_departamentos']['embutida_filho'] as $ind => $sc_init)
          {
