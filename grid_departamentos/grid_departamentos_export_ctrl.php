<?php
@session_start() ;
$_SESSION['scriptcase']['grid_departamentos']['sc_process_barr'] = true;
require_once('../grid_departamentos/index.php');
unset($_SESSION['scriptcase']['grid_departamentos']['sc_process_barr']);
$ExportCtrl = new grid_departamentos_export_control;
$ExportCtrl->Export_barr();

class grid_departamentos_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> departamentos :: Excel</TITLE>
