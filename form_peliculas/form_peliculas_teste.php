<?php  
  ...
  session_start() ;
  class form_peliculas_form_teste
  {
   function form_peliculas_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_peliculas/img";
...
<?php
  ...
  $frm_teste = new form_peliculas_form_teste();
  $frm_teste->form_peliculas_teste();
?>
