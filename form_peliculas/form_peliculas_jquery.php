...
function scEventControl_init(iSeqRow) {
  ...
  scEventControl_data["calificacionedad_" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
}
...
function scEventControl_active(iSeqRow) {
  ...
  if (scEventControl_data["calificacionedad_" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["calificacionedad_" + iSeqRow]["change"]) {
    return true;
  }
  return false;
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_codigo_' + iSeqRow).bind('blur', function() { sc_form_peliculas_codigo__onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_peliculas_codigo__onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_peliculas_codigo__onfocus(this, iSeqRow) });
  $('#id_sc_field_nombre_' + iSeqRow).bind('blur', function() { sc_form_peliculas_nombre__onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_peliculas_nombre__onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_peliculas_nombre__onfocus(this, iSeqRow) });
  $('#id_sc_field_calificacionedad_' + iSeqRow).bind('blur', function() { sc_form_peliculas_calificacionedad__onblur(this, iSeqRow) })
                                               .bind('change', function() { sc_form_peliculas_calificacionedad__onchange(this, iSeqRow) })
                                               .bind('focus', function() { sc_form_peliculas_calificacionedad__onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_peliculas_codigo__onblur(oThis, iSeqRow) {
  do_ajax_form_peliculas_validate_codigo_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_peliculas_codigo__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_peliculas_codigo__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_peliculas_nombre__onblur(oThis, iSeqRow) {
  do_ajax_form_peliculas_validate_nombre_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_peliculas_nombre__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_peliculas_nombre__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_peliculas_calificacionedad__onblur(oThis, iSeqRow) {
  do_ajax_form_peliculas_validate_calificacionedad_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_peliculas_calificacionedad__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_peliculas_calificacionedad__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}
...
function displayChange_block_0(status) {
	...
	displayChange_field("calificacionedad_", "", status);
}

function displayChange_row(row, status) {
	displayChange_field_codigo_(row, status);
	displayChange_field_nombre_(row, status);
	displayChange_field_calificacionedad_(row, status);
}
...
function displayChange_field_calificacionedad_(row, status) {
}
...
function scHidePage(pageNo) {
	$("#id_form_peliculas_form" + pageNo).hide();
}
