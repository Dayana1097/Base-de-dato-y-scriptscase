<?php  
  ...
  session_start() ;
  class form_facultad_form_teste
  {
   function form_facultad_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_facultad/img";
...
<?php
  ...
  $frm_teste = new form_facultad_form_teste();
  $frm_teste->form_facultad_teste();
?>
