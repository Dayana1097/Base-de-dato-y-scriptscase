...
function scEventControl_init(iSeqRow) {
  ...
  scEventControl_data["horas_" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
}
...
function scEventControl_active(iSeqRow) {
  ...
  if (scEventControl_data["horas_" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["horas_" + iSeqRow]["change"]) {
    return true;
  }
  return false;
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id_' + iSeqRow).bind('blur', function() { sc_form_proyecto_id__onblur(this, iSeqRow) })
                                 .bind('change', function() { sc_form_proyecto_id__onchange(this, iSeqRow) })
                                 .bind('focus', function() { sc_form_proyecto_id__onfocus(this, iSeqRow) });
  $('#id_sc_field_nombre_' + iSeqRow).bind('blur', function() { sc_form_proyecto_nombre__onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_proyecto_nombre__onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_proyecto_nombre__onfocus(this, iSeqRow) });
  $('#id_sc_field_horas_' + iSeqRow).bind('blur', function() { sc_form_proyecto_horas__onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_proyecto_horas__onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_proyecto_horas__onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_proyecto_id__onblur(oThis, iSeqRow) {
  do_ajax_form_proyecto_validate_id_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_proyecto_id__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_proyecto_id__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_proyecto_nombre__onblur(oThis, iSeqRow) {
  do_ajax_form_proyecto_validate_nombre_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_proyecto_nombre__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_proyecto_nombre__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_proyecto_horas__onblur(oThis, iSeqRow) {
  do_ajax_form_proyecto_validate_horas_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_proyecto_horas__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_proyecto_horas__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}
...
function displayChange_field_horas_(row, status) {
}
...
function scHidePage(pageNo) {
	$("#id_form_proyecto_form" + pageNo).hide();
}
