<?php  
  ...
  session_start() ;
  class form_proyecto_form_teste
  {
   function form_proyecto_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_proyecto/img";
...
<?php
  ...
  $frm_teste = new form_proyecto_form_teste();
  $frm_teste->form_proyecto_teste();
?>
