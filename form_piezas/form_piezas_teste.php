<?php  
  ...
  session_start() ;
  class form_piezas_form_teste
  {
   function form_piezas_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_piezas/img";
...
<?php
  ...
  $frm_teste = new form_piezas_form_teste();
  $frm_teste->form_piezas_teste();
?>
