...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Almacen_____grid_investigadores"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Almacen_____grid_investigadores"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_investigadores'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_investigadores']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_investigadores']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_investigadores']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_investigadores']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_investigadores']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_investigadores</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_investigadores']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_investigadores']['embutida_filho'] as $ind => $sc_init)
          {
