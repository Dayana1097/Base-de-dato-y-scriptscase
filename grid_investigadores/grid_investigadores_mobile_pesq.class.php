...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "facultad";$Nm_numeric[] = "facultad";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_nomapels_cond" name="nomapels_cond" onChange="nm_campos_between(document.getElementById('id_vis_nomapels'), this, 'nomapels')">
      ...
      <br><span id="id_hide_nomapels"  <?php echo $str_hide_nomapels?>><?php
      if ($nomapels != "")
      {
      $nomapels_look = substr($this->Db->qstr($nomapels), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_facultad_cond" name="facultad_cond" onChange="nm_campos_between(document.getElementById('id_vis_facultad'), this, 'facultad')">
      ...
      <br><span id="id_hide_facultad"  <?php echo $str_hide_facultad?>><INPUT  type="text" id="SC_facultad" name="facultad" value="<?php echo NM_encode_input($facultad) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
