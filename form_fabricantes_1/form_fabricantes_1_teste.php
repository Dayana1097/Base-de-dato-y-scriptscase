<?php  
  ...
  session_start() ;
  class form_fabricantes_1_form_teste
  {
   function form_fabricantes_1_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_fabricantes_1/img";
...
<?php
  ...
  $frm_teste = new form_fabricantes_1_form_teste();
  $frm_teste->form_fabricantes_1_teste();
?>
