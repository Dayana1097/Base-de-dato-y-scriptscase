...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "codigo";$Nm_numeric[] = "pelicula";$Nm_numeric[] = "codigo";$Nm_numeric[] = "pelicula";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_pelicula_cond" name="pelicula_cond" onChange="nm_campos_between(document.getElementById('id_vis_pelicula'), this, 'pelicula')">
      ...
      <br><span id="id_hide_pelicula"  <?php echo $str_hide_pelicula?>><INPUT  type="text" id="SC_pelicula" name="pelicula" value="<?php echo NM_encode_input($pelicula) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
