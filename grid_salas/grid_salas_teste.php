<?php  
  ...
  session_start() ;
  class grid_salas_form_teste
  {
  function grid_salas_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_salas</FONT></B> 
<br> 
<br> 
...
<input type=submit value="grid_salas"> 
</form> 
...
<?php
  ...
  $frm_teste = new grid_salas_form_teste();
  $frm_teste->grid_salas_teste();
?>
