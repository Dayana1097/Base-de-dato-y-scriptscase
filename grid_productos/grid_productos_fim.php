...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Almacen_____grid_productos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Almacen_____grid_productos"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_productos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_productos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_productos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_productos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_productos']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_productos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_productos']['embutida_filho'] as $ind => $sc_init)
          {
