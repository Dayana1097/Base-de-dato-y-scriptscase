...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["codigo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos']['labels']["codigo"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos']['labels']["codigo"] : "Codigo";
   $tab_ger_campos['nombre'] = "on";
   $tab_def_campos['nombre'] = "nombre";
   $tab_labels["nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos']['labels']["nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos']['labels']["nombre"] : "Nombre";
   $tab_ger_campos['precio'] = "on";
   $tab_def_campos['precio'] = "precio";
   $tab_labels["precio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos']['labels']["precio"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos']['labels']["precio"] : "Precio";
