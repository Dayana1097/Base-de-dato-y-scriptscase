<?php  
  ...
  session_start() ;
  class form_maquinas_registradoras_form_teste
  {
   function form_maquinas_registradoras_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_maquinas_registradoras/img";
...
<?php
  ...
  $frm_teste = new form_maquinas_registradoras_form_teste();
  $frm_teste->form_maquinas_registradoras_teste();
?>
