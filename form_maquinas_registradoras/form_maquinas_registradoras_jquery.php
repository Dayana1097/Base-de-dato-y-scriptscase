...
function scEventControl_init(iSeqRow) {
  ...
  scEventControl_data["piso_" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
}
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_codigo_' + iSeqRow).bind('blur', function() { sc_form_maquinas_registradoras_codigo__onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_maquinas_registradoras_codigo__onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_maquinas_registradoras_codigo__onfocus(this, iSeqRow) });
  $('#id_sc_field_piso_' + iSeqRow).bind('blur', function() { sc_form_maquinas_registradoras_piso__onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_maquinas_registradoras_piso__onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_maquinas_registradoras_piso__onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_maquinas_registradoras_codigo__onblur(oThis, iSeqRow) {
  do_ajax_form_maquinas_registradoras_validate_codigo_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_maquinas_registradoras_codigo__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_maquinas_registradoras_codigo__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_maquinas_registradoras_piso__onblur(oThis, iSeqRow) {
  do_ajax_form_maquinas_registradoras_validate_piso_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_maquinas_registradoras_piso__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_maquinas_registradoras_piso__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}
...
function displayChange_block_0(status) {
	...
	displayChange_field("piso_", "", status);
}

function displayChange_row(row, status) {
	displayChange_field_codigo_(row, status);
	displayChange_field_piso_(row, status);
}
...
function displayChange_field_piso_(row, status) {
}
...
function scHidePage(pageNo) {
	$("#id_form_maquinas_registradoras_form" + pageNo).hide();
}
