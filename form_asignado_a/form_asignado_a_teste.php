<?php  
  ...
  session_start() ;
  class form_asignado_a_form_teste
  {
   function form_asignado_a_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_asignado_a/img";
...
<?php
  ...
  $frm_teste = new form_asignado_a_form_teste();
  $frm_teste->form_asignado_a_teste();
?>
