...
//
   ...
   $_SESSION['scriptcase']['form_productos']['glo_nm_perfil']          = "";
   $_SESSION['scriptcase']['form_productos']['glo_nm_path_prod']       = "/scriptcase/prod";
   $_SESSION['scriptcase']['form_productos']['glo_nm_path_imagens']    = "/scriptcase/file/img";
   $_SESSION['scriptcase']['form_productos']['glo_nm_path_imag_temp']  = "/scriptcase/tmp";
   $_SESSION['scriptcase']['form_productos']['glo_nm_path_doc']        = "C:/Program Files/NetMake/v9/wwwroot/scriptcase/file/doc";
   $_SESSION['scriptcase']['form_productos']['glo_nm_conexao']         = "conn_mysql_4";
   $NM_dir_atual = getcwd();
          ...
          foreach ($_SESSION['scriptcase']['user_logout'] as $ind => $parms)
          {
              if (isset($_SESSION[$parms['V']]) && $_SESSION[$parms['V']] == $parms['U'])
              {
                  ...
                  if (isset($inicial_form_productos->contr_form_productos->NM_ajax_flag) && $inicial_form_productos->contr_form_productos->NM_ajax_flag)
                  {
                      ...
                      $inicial_form_productos->contr_form_productos->NM_ajax_info['redir']['script_case_session']  = session_id();
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos']['ordem_cmp'] = ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos']['ordem_ord'] = ""; 
      $this->conectDB();
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['form_productos']['glo_nm_conexao'], $this->root . $this->path_prod, 'Almacen'); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['form_productos']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['form_productos']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['form_productos']['glo_nm_conexao'], $this->root . $this->path_prod, 'Almacen', 1, true);
    }
    else {
...
class form_productos_edit
{
    ...
    function inicializa()
    {
        ...
        require_once("form_productos_form0.php");
        $this->contr_form_productos = new form_productos_form();
    }
}
...
//
    ...
    if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
        ...
        elseif (is_file($root . $_SESSION['scriptcase']['form_productos']['glo_nm_path_imag_temp'] . "/sc_apl_default_Almacen.txt")) {
            $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['form_productos']['glo_nm_path_imag_temp'] . "/sc_apl_default_Almacen.txt"));
        }
        if (isset($apl_def)) {
            ...
            if (isset($_COOKIE['sc_actual_lang_Almacen'])) {
                $_SESSION['scriptcase']['form_productos']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_Almacen'];
            }
        }
    }
    ...
    {
        if ('ajax_form_productos_validate_codigo_' == $_POST['rs'])
        {
        ...
        if ('ajax_form_productos_validate_nombre_' == $_POST['rs'])
        {
            $nombre_ = NM_utf8_urldecode($_POST['rsargs'][0]);
            $nmgp_refresh_row = NM_utf8_urldecode($_POST['rsargs'][1]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][2]);
        }
        if ('ajax_form_productos_validate_precio_' == $_POST['rs'])
        {
        ...
        if ('ajax_form_productos_add_new_line' == $_POST['rs'])
        {
        ...
        if ('ajax_form_productos_backup_line' == $_POST['rs'])
        {
            $codigo_ = NM_utf8_urldecode($_POST['rsargs'][0]);
            $nmgp_refresh_row = NM_utf8_urldecode($_POST['rsargs'][1]);
        ...
        if ('ajax_form_productos_table_refresh' == $_POST['rs'])
        {
            $codigo_ = NM_utf8_urldecode($_POST['rsargs'][0]);
            $nm_form_submit = NM_utf8_urldecode($_POST['rsargs'][1]);
            $nmgp_opcao = NM_utf8_urldecode($_POST['rsargs'][2]);
    ...
    else
    {
        ...
        elseif ($_SESSION['sc_session'][$script_case_init]['form_productos']['run_iframe'] != "F" && $_SESSION['sc_session'][$script_case_init]['form_productos']['run_iframe'] != "R")
        {
           ...
           $nm_url_saida = str_replace("_fim.php", ".php", $nm_url_saida); 
            ...
            {
                $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['form_productos']['retorno_edit'] . "?script_case_init=" . $script_case_init . "&script_case_session=" . session_id();  
                $nm_apl_dependente = 1 ; 
                $nm_saida_global = $nm_url_saida;
            } 
        ...
        { 
            if (!empty($nmgp_url_saida) && empty($_SESSION['sc_session'][$script_case_init]['form_productos']['retorno_edit'])) 
            {
                $_SESSION['sc_session'][$script_case_init]['form_productos']['retorno_edit'] = $nmgp_url_saida . "?script_case_init=" . $script_case_init . "&script_case_session=" . session_id(); 
            } 
        } 
    ...
    sajax_init();
    //$sajax_debug_mode = 1;
    sajax_export("ajax_form_productos_validate_codigo_");
    sajax_export("ajax_form_productos_validate_nombre_");
    sajax_export("ajax_form_productos_validate_precio_");
    sajax_export("ajax_form_productos_submit_form");
    sajax_export("ajax_form_productos_navigate_form");
    sajax_export("ajax_form_productos_add_new_line");
    sajax_export("ajax_form_productos_backup_line");
    sajax_export("ajax_form_productos_table_refresh");
...
//
    ...
    function ajax_form_productos_validate_codigo_($codigo_, $nmgp_refresh_row, $script_case_init)
    {
        global $inicial_form_productos;
        ...
        $inicial_form_productos->contr_form_productos->NM_ajax_opcao         = 'validate_codigo_';
    ...
    function ajax_form_productos_validate_nombre_($nombre_, $nmgp_refresh_row, $script_case_init)
    {
        global $inicial_form_productos;
        //register_shutdown_function("form_productos_pack_ajax_response");
        $inicial_form_productos->contr_form_productos->NM_ajax_flag          = true;
        $inicial_form_productos->contr_form_productos->NM_ajax_opcao         = 'validate_nombre_';
        $inicial_form_productos->contr_form_productos->NM_ajax_info['param'] = array(
    ...
    function ajax_form_productos_validate_precio_($precio_, $nmgp_refresh_row, $script_case_init)
    {
        global $inicial_form_productos;
        //register_shutdown_function("form_productos_pack_ajax_response");
        $inicial_form_productos->contr_form_productos->NM_ajax_flag          = true;
        $inicial_form_productos->contr_form_productos->NM_ajax_opcao         = 'validate_precio_';
        $inicial_form_productos->contr_form_productos->NM_ajax_info['param'] = array(
    ...
    function ajax_form_productos_submit_form($codigo_, $nombre_, $precio_, $nmgp_refresh_row, $nm_form_submit, $nmgp_url_saida, $nmgp_opcao, $nmgp_ancora, $nmgp_num_form, $nmgp_parms, $script_case_init, $csrf_token)
    {
        global $inicial_form_productos;
        //register_shutdown_function("form_productos_pack_ajax_response");
        $inicial_form_productos->contr_form_productos->NM_ajax_flag          = true;
    ...
    function ajax_form_productos_navigate_form($codigo_, $nm_form_submit, $nmgp_opcao, $nmgp_ordem, $nmgp_arg_dyn_search, $script_case_init)
    {
        global $inicial_form_productos;
        //register_shutdown_function("form_productos_pack_ajax_response");
        $inicial_form_productos->contr_form_productos->NM_ajax_flag          = true;
    ...
    function ajax_form_productos_add_new_line($sc_clone, $sc_seq_clone, $sc_seq_vert, $script_case_init)
    {
        global $inicial_form_productos;
        //register_shutdown_function("form_productos_pack_ajax_response");
        $inicial_form_productos->contr_form_productos->NM_ajax_flag          = true;
        $inicial_form_productos->contr_form_productos->NM_ajax_opcao         = 'add_new_line';
        $inicial_form_productos->contr_form_productos->NM_ajax_info['param'] = array(
    ...
    function ajax_form_productos_backup_line($codigo_, $nmgp_refresh_row, $nm_form_submit, $script_case_init)
    {
        global $inicial_form_productos;
        //register_shutdown_function("form_productos_pack_ajax_response");
        $inicial_form_productos->contr_form_productos->NM_ajax_flag          = true;
        $inicial_form_productos->contr_form_productos->NM_ajax_opcao         = 'backup_line';
        $inicial_form_productos->contr_form_productos->NM_ajax_info['param'] = array(
                  'codigo_' => NM_utf8_urldecode($codigo_),
                  'nmgp_refresh_row' => NM_utf8_urldecode($nmgp_refresh_row),
                  'nm_form_submit' => NM_utf8_urldecode($nm_form_submit),
    ...
    function ajax_form_productos_table_refresh($codigo_, $nm_form_submit, $nmgp_opcao, $nmgp_ordem, $nmgp_fast_search, $nmgp_cond_fast_search, $nmgp_arg_fast_search, $nmgp_arg_dyn_search, $script_case_init)
    {
        global $inicial_form_productos;
        //register_shutdown_function("form_productos_pack_ajax_response");
        $inicial_form_productos->contr_form_productos->NM_ajax_flag          = true;
        $inicial_form_productos->contr_form_productos->NM_ajax_opcao         = 'table_refresh';
        $inicial_form_productos->contr_form_productos->NM_ajax_info['param'] = array(
                  'codigo_' => NM_utf8_urldecode($codigo_),
                  'nm_form_submit' => NM_utf8_urldecode($nm_form_submit),
                  'nmgp_opcao' => NM_utf8_urldecode($nmgp_opcao),
