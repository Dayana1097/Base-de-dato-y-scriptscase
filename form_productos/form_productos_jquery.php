...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_codigo_' + iSeqRow).bind('blur', function() { sc_form_productos_codigo__onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_productos_codigo__onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_productos_codigo__onfocus(this, iSeqRow) });
  $('#id_sc_field_nombre_' + iSeqRow).bind('blur', function() { sc_form_productos_nombre__onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_productos_nombre__onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_productos_nombre__onfocus(this, iSeqRow) });
  $('#id_sc_field_precio_' + iSeqRow).bind('blur', function() { sc_form_productos_precio__onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_productos_precio__onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_productos_precio__onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_productos_codigo__onblur(oThis, iSeqRow) {
  do_ajax_form_productos_validate_codigo_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_productos_codigo__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_productos_codigo__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_productos_nombre__onblur(oThis, iSeqRow) {
  do_ajax_form_productos_validate_nombre_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_productos_nombre__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_productos_nombre__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_productos_precio__onblur(oThis, iSeqRow) {
  do_ajax_form_productos_validate_precio_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_productos_precio__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_productos_precio__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}
...
function scHidePage(pageNo) {
	$("#id_form_productos_form" + pageNo).hide();
}
