<?php  
  ...
  session_start() ;
  class form_productos_form_teste
  {
   function form_productos_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_productos/img";
...
<?php
  ...
  $frm_teste = new form_productos_form_teste();
  $frm_teste->form_productos_teste();
?>
