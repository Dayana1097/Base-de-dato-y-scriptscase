<?php  
  ...
  session_start() ;
  class grid_piezas_form_teste
  {
  function grid_piezas_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_piezas</FONT></B> 
<br> 
<br> 
...
<input type=submit value="grid_piezas"> 
</form> 
...
<?php
  ...
  $frm_teste = new grid_piezas_form_teste();
  $frm_teste->grid_piezas_teste();
?>
