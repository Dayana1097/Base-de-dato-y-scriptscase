...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "horas";$Nm_numeric[] = "horas";
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> proyecto</div>
...
<?php
   ...
   function monta_form()
   {
      ...
      { 
          ...
          $id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['campos_busca']['id']; 
          $id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['campos_busca']['id_cond']; 
          $nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['campos_busca']['nombre']; 
          $nombre_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['campos_busca']['nombre_cond']; 
          $horas = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['campos_busca']['horas']; 
          $horas_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['campos_busca']['horas_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['campos_busca']['NM_operador']; 
          if (strtoupper($horas_cond) != "II" && strtoupper($horas_cond) != "QP" && strtoupper($horas_cond) != "NP" && strtoupper($horas_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($horas, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
...
?>
<INPUT  type="text" id="SC_nombre" name="nombre" value="<?php echo NM_encode_input($nombre) ?>"  size=50 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_nombre" name="nombre_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_horas_cond" name="horas_cond" onChange="nm_campos_between(document.getElementById('id_vis_horas'), this, 'horas')">
       <OPTION value="gt" <?php if ("gt" == $horas_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $horas_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $horas_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_horas"  <?php echo $str_hide_horas?>><INPUT  type="text" id="SC_horas" name="horas" value="<?php echo NM_encode_input($horas) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.horas_cond.value = 'gt';
...
<?php
   ...
   function trata_campos()
   {
      global $id_cond, $id, $id_autocomp,
             $nombre_cond, $nombre, $nombre_autocomp,
             $horas_cond, $horas, $nmgp_tab_label;
      ...
      if ($horas_cond != "in")
      {
          nm_limpa_numero($horas, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $horas);
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['campos_busca']['id'] = $id; 
      if (is_array($id) && !empty($id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['Grid_search'][$I_Grid]['val'][0] = $id;
      }
      elseif ($id_cond_salva == "nu" || $id_cond_salva == "nn" || $id_cond_salva == "ep" || $id_cond_salva == "ne" ||  !empty($id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['Grid_search'][$I_Grid]['val'][0][0] = $id;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['campos_busca']['id_cond'] = $id_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['Grid_search'][$I_Grid]['cmp'] = "id"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['Grid_search'][$I_Grid]['opc'] = $id_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['grid_pesq']['id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['campos_busca']['nombre'] = $nombre; 
      if (is_array($nombre) && !empty($nombre))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['Grid_search'][$I_Grid]['val'][0] = $nombre;
      }
      elseif ($nombre_cond_salva == "nu" || $nombre_cond_salva == "nn" || $nombre_cond_salva == "ep" || $nombre_cond_salva == "ne" ||  !empty($nombre))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['Grid_search'][$I_Grid]['val'][0][0] = $nombre;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['campos_busca']['nombre_cond'] = $nombre_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['Grid_search'][$I_Grid]['cmp'] = "nombre"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['Grid_search'][$I_Grid]['opc'] = $nombre_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['grid_pesq']['nombre'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['campos_busca']['horas'] = $horas; 
      if (is_array($horas) && !empty($horas))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['Grid_search'][$I_Grid]['val'][0] = $horas;
      }
      elseif ($horas_cond_salva == "nu" || $horas_cond_salva == "nn" || $horas_cond_salva == "ep" || $horas_cond_salva == "ne" ||  !empty($horas))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['Grid_search'][$I_Grid]['val'][0][0] = $horas;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['campos_busca']['horas_cond'] = $horas_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['Grid_search'][$I_Grid]['cmp'] = "horas"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['Grid_search'][$I_Grid]['opc'] = $horas_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['grid_pesq']['horas'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      ...
      {
         $this->monta_condicao("horas", $horas_cond, $horas, "", "horas");
      }
   }
