...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Almacen_____grid_proyecto"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Almacen_____grid_proyecto"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_proyecto'] = array();
   $fecha_janela = false;
