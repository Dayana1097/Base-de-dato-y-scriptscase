<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['grid_proyecto']['glo_nm_perfil']          = "";
   $_SESSION['scriptcase']['grid_proyecto']['glo_nm_path_prod']       = "/scriptcase/prod";
   $_SESSION['scriptcase']['grid_proyecto']['glo_nm_path_conf']       = "C:/Program Files/NetMake/v9/wwwroot/scriptcase/conf";
   $_SESSION['scriptcase']['grid_proyecto']['glo_nm_path_imagens']    = "/scriptcase/file/img";
   $_SESSION['scriptcase']['grid_proyecto']['glo_nm_path_imag_temp']  = "/scriptcase/tmp";
   $_SESSION['scriptcase']['grid_proyecto']['glo_nm_path_doc']        = "C:/Program Files/NetMake/v9/wwwroot/scriptcase/file/doc";
   $_SESSION['scriptcase']['grid_proyecto']['glo_nm_conexao']         = "conn_mysql_2";
...
<?php
      ...
      $Tmp_apl_lig = "form_proyecto";
      if (is_file($this->root . $this->path_link . "_lib/friendly_url/form_proyecto_ini.txt"))
      {
          $Friendly = file($this->root . $this->path_link . "_lib/friendly_url/form_proyecto_ini.txt");
          if (isset($Friendly[0]) && !empty($Friendly[0]))
          {
              $Tmp_apl_lig = trim($Friendly[0]);
          }
      }
      if (is_file($this->root . $this->path_link . $Tmp_apl_lig . "/form_proyecto_ini.txt"))
      {
          $L_md5 = file($this->root . $this->path_link . $Tmp_apl_lig . "/form_proyecto_ini.txt");
          if (isset($L_md5[6]) && trim($L_md5[6]) == "LigMd5")
          {
              $this->sc_lig_md5["form_proyecto"] = 'S';
          }
      }
      $this->sc_lig_target["A_@scinf_"] = '';
      $this->sc_lig_target["A_@scinf__@scinf_form_proyecto"] = '';
      ...
      $this->link_form_proyecto =  $this->sc_protocolo . $this->server . $this->path_link . "" . SC_dir_app_name('form_proyecto') . "/" ; 
      if ($Tp_init == "Path_sub")
      {
          return;
      }
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_proyecto']['glo_nm_conexao'], $this->root . $this->path_prod, 'Almacen'); 
      } 
      else 
      { 
          ob_start();
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if (!$this->Ini || isset($_SESSION['sc_session'][$script_case_init]['grid_proyecto']['embutida_ibase'])) 
      { 
          $this->Ini = new grid_proyecto_ini(); 
          $this->Ini->init();
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['embutida'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['embutida_ibase'] = true;
      }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['pdf_det'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['opcao'] = 'pdf';
          $_SESSION['sc_session'][$script_case_init]['grid_proyecto']['opc_pdf']['pdf_zip'] = (isset($Det_pdf_zip) && !empty($Det_pdf_zip)) ? $Det_pdf_zip : "N";
          if ($Det_use_pass_pdf != "__APL__")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['use_pass_pdf'] = $Det_use_pass_pdf;
          } 
          $nmgp_opcao = 'pdf';
      }
      if ($nmgp_opcao == 'pdf')
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['proc_pdf']      = (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['embutida'] && ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['opcao'] == "pdf_res")) ? true : false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['proc_pdf_vert'] = false;
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['field_order'][] = "id";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['field_order'][] = "nombre";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['field_order'][] = "horas";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['field_order_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['field_order'];
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['det_print'] = "";
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['opcao'] == "det_print")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['opcao']     = "detalhe";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['det_print'] = "print";
          if (!empty($nmgp_password)) {
          ...
          {
              $this->Ini->Export_img_zip = true;
              $nm_arquivo_html = "/sc_grid_proyecto_det_" . session_id() . ".html";
              $nm_saida->seta_arquivo($this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_html);
          }
      } 
...
//
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['embutida'])
      {
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            {
                $nm_arquivo_pdf_base = "/sc_pdf_" . date("YmdHis") . "_" . rand(0, 1000) . "_grid_proyecto.pdf";
...
//----------------------------------->
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['opcao'] == "rtf")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_proyecto/grid_proyecto_rtf.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_proyecto_rtf.class.php"); 
          } 
          $this->rtf  = new grid_proyecto_rtf();
      ...
      { 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['opcao'] == "detalhe" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['pdf_det'])  
          { 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['embutida'])
              { 
                  require_once($this->Ini->path_embutida . "grid_proyecto/grid_proyecto_det.class.php"); 
              } 
              else 
              { 
                  require_once($this->Ini->path_aplicacao . "grid_proyecto_det.class.php"); 
              } 
              $this->det  = new grid_proyecto_det();
...
<?php
  ...
  function close_emb()
  {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['fast_search'][0] = $field;
   ...
   {
      if (is_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto']['campos_busca'][$cmp_del]))
      {
...
<?php
 ...
 $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto'][$path_doc_md5][0] = $nm_arquivo_pdf_det;
 $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proyecto'][$path_doc_md5][1] = "grid_proyecto_det.pdf";
?>
 <META http-equiv="Expires" content="Fri, Jan 01 1900 00:00:00 GMT"/>
 <META http-equiv="Last-Modified" content="<?php echo gmdate("D, d M Y H:i:s"); ?> GMT"/>
 <META http-equiv="Cache-Control" content="no-store, no-cache, must-revalidate"/>
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['grid_proyecto']['glo_nm_path_imag_temp'] . "/sc_apl_default_Almacen.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['grid_proyecto']['glo_nm_path_imag_temp'] . "/sc_apl_default_Almacen.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_Almacen'])) {
               $_SESSION['scriptcase']['grid_proyecto']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_Almacen'];
           }
       }
   }
   ...
   { 
       ...
       if ($_SESSION['sc_session'][$script_case_init]['grid_proyecto']['opcao'] == "detalhe" && isset($nmgp_chave_det))  
       { 
           $_SESSION['sc_session'][$script_case_init]['grid_proyecto']['chave_det'] = $nmgp_chave_det;
           $_SESSION['sc_session'][$script_case_init]['grid_proyecto']['cmp_acum']  = $nmgp_parm_acum;
       }   
       if (isset($Sc_seq_det))  
       { 
           $_SESSION['sc_session'][$script_case_init]['grid_proyecto']['Sc_seq_det'] = $Sc_seq_det;
       } 
       if (!isset($_SESSION['sc_session'][$script_case_init]['grid_proyecto']['mostra_edit'])) 
       {
           $_SESSION['sc_session'][$script_case_init]['grid_proyecto']['mostra_edit'] = "S";
       }
