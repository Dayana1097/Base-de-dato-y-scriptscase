...
?>
 ...
 function checkPDF() {
  $.get(nm_url_rand("grid_proyecto_gauge_ctrl.php"), {
...
<?php
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_proyecto']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_proyecto']['pdf_name'] : 'sc_pdf_' . date('YmdHis') . '_' . rand(0, 1000) . '_grid_proyecto.pdf';
...
$_SESSION['sc_session'][$aParams['script_case_init']]['grid_proyecto'][$path_doc_md5][0] = $NM_pdfurl . "/" . $NM_pdf_output;
