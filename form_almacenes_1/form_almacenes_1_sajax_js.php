  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_almacenes_1" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_almacenes_1_form();
	}

  // ---------- Validate codigo_
  function do_ajax_form_almacenes_1_validate_codigo_(iNumLinha)
  {
    var nomeCampo_codigo_ = "codigo_" + iNumLinha;
    var var_codigo_ = scAjaxGetFieldText(nomeCampo_codigo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_almacenes_1_validate_codigo_(var_codigo_, iNumLinha, var_script_case_init, do_ajax_form_almacenes_1_validate_codigo__cb);
  } // do_ajax_form_almacenes_1_validate_codigo_

  function do_ajax_form_almacenes_1_validate_codigo__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_almacenes_1_validate_codigo__cb

  // ---------- Validate lugar_
  function do_ajax_form_almacenes_1_validate_lugar_(iNumLinha)
  {
    var nomeCampo_lugar_ = "lugar_" + iNumLinha;
    var var_lugar_ = scAjaxGetFieldText(nomeCampo_lugar_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_almacenes_1_validate_lugar_(var_lugar_, iNumLinha, var_script_case_init, do_ajax_form_almacenes_1_validate_lugar__cb);
  } // do_ajax_form_almacenes_1_validate_lugar_

  function do_ajax_form_almacenes_1_validate_lugar__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "lugar_" + iLineNumber;
    }
    else
    {
      sFieldValid = "lugar_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "lugar_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "lugar_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_almacenes_1_validate_lugar__cb

  // ---------- Validate capacidad_
  function do_ajax_form_almacenes_1_validate_capacidad_(iNumLinha)
  {
    var nomeCampo_capacidad_ = "capacidad_" + iNumLinha;
    var var_capacidad_ = scAjaxGetFieldText(nomeCampo_capacidad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_almacenes_1_validate_capacidad_(var_capacidad_, iNumLinha, var_script_case_init, do_ajax_form_almacenes_1_validate_capacidad__cb);
  } // do_ajax_form_almacenes_1_validate_capacidad_

  function do_ajax_form_almacenes_1_validate_capacidad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_almacenes_1_validate_capacidad__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_almacenes_1_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_almacenes_1_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_almacenes_1_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_almacenes_1_add_new_line_cb);
  } // do_ajax_form_almacenes_1_add_new_line

  function do_ajax_form_almacenes_1_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_almacenes_1_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_almacenes_1_backup_line(iNumLinha)
  {
    var var_codigo_ = scAjaxGetFieldText("codigo_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_almacenes_1_backup_line(var_codigo_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_almacenes_1_backup_line_cb);
  } // do_ajax_form_almacenes_1_backup_line

  function do_ajax_form_almacenes_1_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_almacenes_1_backup_line_cb

  function do_ajax_form_almacenes_1_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_almacenes_1_cancel_insert

  function do_ajax_form_almacenes_1_cancel_update(iSeqVert)
  {
    do_ajax_form_almacenes_1_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_almacenes_1_cancel_update

  function do_ajax_form_almacenes_1_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_almacenes_1_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_almacenes_1_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_almacenes_1_table_refresh(var_codigo_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_almacenes_1_table_refresh_cb);
  } //  do_ajax_form_almacenes_1_table_refresh

  function do_ajax_form_almacenes_1_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scQSInit = false;
    scAjaxAlert(do_ajax_form_almacenes_1_table_refresh_cb_after_alert);
  } // do_ajax_form_almacenes_1_table_refresh_cb
  function do_ajax_form_almacenes_1_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_almacenes_1_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_almacenes_1_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_almacenes_1_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_codigo_ = scAjaxGetFieldText("codigo_" + iNumLinha);
    var var_lugar_ = scAjaxGetFieldText("lugar_" + iNumLinha);
...
?>
    x_ajax_form_almacenes_1_submit_form(var_codigo_, var_lugar_, var_capacidad_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_almacenes_1_submit_form_cb);
  } // do_ajax_form_almacenes_1_submit_form

  function do_ajax_form_almacenes_1_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("lugar_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_almacenes_1_submit_form_cb_after_alert);
  } // do_ajax_form_almacenes_1_submit_form_cb
  function do_ajax_form_almacenes_1_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_almacenes_1_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_almacenes_1_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_almacenes_1_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("lugar_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_almacenes_1_navigate_form(var_codigo_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_almacenes_1_navigate_form_cb);
  } // do_ajax_form_almacenes_1_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_almacenes_1']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_almacenes_1_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_almacenes_1_navigate_form_cb_after_alert);
  } // do_ajax_form_almacenes_1_navigate_form_cb
  function do_ajax_form_almacenes_1_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_almacenes_1_navigate_form_cb_after_alert
  function sc_hide_form_almacenes_1_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "lugar_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["lugar_" + iNumLinha] = {"label": "Lugar<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["lugar_"][iNumLinha] = "lugar_" + iNumLinha;
    ...
    ajax_field_id["lugar_" + iNumLinha] = new Array("hidden_field_label_lugar_", "hidden_field_data_lugar_" + iNumLinha);
    ...
    ajax_error_count["lugar_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["lugar_" + iNumLinha] = "off";
...
?>
    ajax_read_only["codigo_" + iNumLinha] = "on";
    ajax_read_only["lugar_" + iNumLinha] = "on";
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["lugar_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["lugar_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["lugar_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["lugar_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["lugar_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["lugar_" + iNumLinha]["onfocus"] = new Array();
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['lugar_'])) ? $this->nmgp_cmp_readonly['lugar_'] : 'off';
?>
    scAjaxFieldRead("lugar_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("lugar_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["codigo_" + iRow] || "on" == ajax_error_count["lugar_" + iRow] || "on" == ajax_error_count["capacidad_" + iRow]))
    {
      ...
      $("#hidden_field_data_lugar_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_capacidad_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["codigo_" + iRow] && "off" == ajax_error_count["lugar_" + iRow] && "off" == ajax_error_count["capacidad_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["codigo_" + iRow] = "off";
        ajax_error_count["lugar_" + iRow] = "off";
      ...
      $("#hidden_field_data_lugar_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_capacidad_" + iRow).removeClass("scFormErrorLine");
    }
  }
