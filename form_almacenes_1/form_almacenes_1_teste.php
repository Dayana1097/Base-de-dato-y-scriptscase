<?php  
  ...
  session_start() ;
  class form_almacenes_1_form_teste
  {
   function form_almacenes_1_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_almacenes_1/img";
...
<?php
  ...
  $frm_teste = new form_almacenes_1_form_teste();
  $frm_teste->form_almacenes_1_teste();
?>
