...
function scEventControl_init(iSeqRow) {
  ...
  scEventControl_data["lugar_" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
  scEventControl_data["capacidad_" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
}
...
function scEventControl_active(iSeqRow) {
  ...
  if (scEventControl_data["lugar_" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["lugar_" + iSeqRow]["change"]) {
    return true;
  }
  if (scEventControl_data["capacidad_" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["capacidad_" + iSeqRow]["change"]) {
    return true;
  }
  return false;
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_codigo_' + iSeqRow).bind('blur', function() { sc_form_almacenes_1_codigo__onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_almacenes_1_codigo__onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_almacenes_1_codigo__onfocus(this, iSeqRow) });
  $('#id_sc_field_lugar_' + iSeqRow).bind('blur', function() { sc_form_almacenes_1_lugar__onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_almacenes_1_lugar__onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_almacenes_1_lugar__onfocus(this, iSeqRow) });
  $('#id_sc_field_capacidad_' + iSeqRow).bind('blur', function() { sc_form_almacenes_1_capacidad__onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_almacenes_1_capacidad__onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_almacenes_1_capacidad__onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_almacenes_1_codigo__onblur(oThis, iSeqRow) {
  do_ajax_form_almacenes_1_validate_codigo_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_almacenes_1_codigo__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_almacenes_1_codigo__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_almacenes_1_lugar__onblur(oThis, iSeqRow) {
  do_ajax_form_almacenes_1_validate_lugar_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_almacenes_1_lugar__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_almacenes_1_lugar__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_almacenes_1_capacidad__onblur(oThis, iSeqRow) {
  do_ajax_form_almacenes_1_validate_capacidad_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_almacenes_1_capacidad__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_almacenes_1_capacidad__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}
...
function displayChange_block_0(status) {
	...
	displayChange_field("lugar_", "", status);
	displayChange_field("capacidad_", "", status);
}

function displayChange_row(row, status) {
	displayChange_field_codigo_(row, status);
	displayChange_field_lugar_(row, status);
	displayChange_field_capacidad_(row, status);
}
...
function displayChange_field_lugar_(row, status) {
}

function displayChange_field_capacidad_(row, status) {
}
...
function scHidePage(pageNo) {
	$("#id_form_almacenes_1_form" + pageNo).hide();
}
