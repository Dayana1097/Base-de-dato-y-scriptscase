...
class form_articulos_apl
{
   ...
   var $form_vert_form_articulos = array();
...
//----- 
   function ini_controle()
   {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_articulos']['nm_run_menu'] = 1;
      } 
      ...
      $_SESSION['sc_session'][$script_case_init]['form_articulos']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_articulos']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_articulos']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " articulos";
      ...
      $_SESSION['scriptcase']['error_icon']['form_articulos']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      ...
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['embutida_call'] : $this->Embutida_call;
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['table_refresh'] = false;
      ...
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['buttonStatus'];
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_articulos'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_articulos'];
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['sc_max_reg']) && strtolower($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['sc_max_reg']) == "all")
      {
...
//
   ...
   function controle()
   {
      ...
      if ($this->nmgp_opcao == "change_qtd_line")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['sc_max_reg'] = $this->nmgp_max_line;
      }
      ...
      if ($this->NM_ajax_flag && 'submit_form' == $this->NM_ajax_opcao)
      {
         ...
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['dados_form'][$sc_seq_vert]))
         {
             $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['dados_form'][$sc_seq_vert];
         }
         ...
         if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "")
         {
             $this->NM_rollback_db();
              if ($this->NM_ajax_flag)
              {
                  if (!isset($this->NM_ajax_info['errList']['geral_form_articulos']) || !is_array($this->NM_ajax_info['errList']['geral_form_articulos']))
                  {
                      $this->NM_ajax_info['errList']['geral_form_articulos'] = array();
                  }
                  if ($Campos_Crit != "")
                  {
                      $this->NM_ajax_info['errList']['geral_form_articulos'][] = $Campos_Crit;
                  }
                  if (!empty($Campos_Falta))
                  {
                      $this->NM_ajax_info['errList']['geral_form_articulos'][] = $this->Formata_Campos_Falta($Campos_Falta);
                  }
                  if ($this->Campos_Mens_erro != "")
                  {
                      $this->NM_ajax_info['errList']['geral_form_articulos'][] = $this->Campos_Mens_erro;
                  }
      ...
      { 
         ...
         {
            $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['dados_select'][$sc_seq_vert];
         }
         ...
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['sc_disabled'] = array();
             $this->controle_form_vert(); 
             ...
             $this->form_vert_form_articulos[$sc_seq_vert]['codigo_'] =  $this->codigo_; 
             $this->form_vert_form_articulos[$sc_seq_vert]['nombre_'] =  $this->nombre_; 
             $this->form_vert_form_articulos[$sc_seq_vert]['precio_'] =  $this->precio_; 
             $this->form_vert_form_articulos[$sc_seq_vert]['fabricante_'] =  $this->fabricante_; 
         }
         $sc_seq_vert++; 
      } 
      ...
      if ($this->NM_ajax_flag && 'table_refresh' == $this->NM_ajax_opcao)
      {
          ...
          $this->NM_ajax_info['rsSize'] = sizeof($this->form_vert_form_articulos);
...
//
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_articulos.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_articulos_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_articulos"> 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              ...
              $this->NM_ajax_info['errList']['geral_form_articulos'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['dados_form'][$sc_seq_vert] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['navStatus']['ret'] = $this->Nav_permite_ret ? 'S' : 'N';
              $this->NM_ajax_info['navStatus']['ava'] = $this->Nav_permite_ava ? 'S' : 'N';
              $this->NM_ajax_info['fldList']['codigo_']['keyVal'] = form_articulos_pack_protect_string($this->nmgp_dados_form['codigo_']);
          }
   } // ajax_return_values
   function ajax_return_values_all_vert()
   {
          ...
          {
              $this->form_vert_form_articulos[$this->nmgp_refresh_row] = $this->NM_ajax_info['param'];
              if ((isset($this->Embutida_ronly) && $this->Embutida_ronly) || $this->NM_ajax_force_values)
              {
                  ...
                  {
                      $this->form_vert_form_articulos[$this->nmgp_refresh_row]['codigo_'] = $this->codigo_;
                  }
                  if (isset($this->NM_ajax_changed['nombre_']) && $this->NM_ajax_changed['nombre_'])
                  {
                      $this->form_vert_form_articulos[$this->nmgp_refresh_row]['nombre_'] = $this->nombre_;
                  }
                  if (isset($this->NM_ajax_changed['precio_']) && $this->NM_ajax_changed['precio_'])
                  {
                      $this->form_vert_form_articulos[$this->nmgp_refresh_row]['precio_'] = $this->precio_;
                  }
                  if (isset($this->NM_ajax_changed['fabricante_']) && $this->NM_ajax_changed['fabricante_'])
                  {
                      $this->form_vert_form_articulos[$this->nmgp_refresh_row]['fabricante_'] = $this->fabricante_;
                  }
              }
          }
          ...
          foreach($this->form_vert_form_articulos as $sc_seq_vert => $aRecData)
          {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   { 
      ...
      if ($this->nmgp_opcao == "alterar")
      {
          ...
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['dados_select'][$sc_seq_vert]['codigo_'] = $this->codigo_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['dados_select'][$sc_seq_vert]['nombre_'] = $this->nombre_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['dados_select'][$sc_seq_vert]['precio_'] = $this->precio_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['dados_select'][$sc_seq_vert]['fabricante_'] = $this->fabricante_;
          }
      }
      ...
      { 
          ...
          { 
              ...
              $this->nombre_ = $this->nombre__before_qstr;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['total']++; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['reg_qtd']++; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['reg_I_E']++; 
              ...
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['parms'] = "codigo_?#?$this->codigo_?@?"; 
      }
...
//---------- 
   ...
   { 
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_articulos']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_articulos']['rows']))
      {
          $this->sc_max_reg = $_SESSION['scriptcase']['sc_apl_conf']['form_articulos']['rows'];
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_articulos']['rows_ins']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_articulos']['rows_ins']))
      {
          $this->sc_max_reg_incl = $_SESSION['scriptcase']['sc_apl_conf']['form_articulos']['rows_ins'];
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['embutida_liga_qtd_reg']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['embutida_liga_qtd_reg'])
      {
          $this->sc_max_reg = $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['embutida_liga_qtd_reg'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['sc_max_reg']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['sc_max_reg'] > 0 || strtolower($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['sc_max_reg']) == "all"))
      {
          $this->sc_max_reg = $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['sc_max_reg'];
      } 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $GLOBALS["NM_ERRO_IBASE"] = 0;  
      $this->form_vert_form_articulos = array();
      ...
      {
          $this->nmgp_opcao = "avanca";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['reg_start'] -= $this->sc_max_reg;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['where_filter'])
      {
      ...
      if ('total' != $this->form_paginacao)
      {
          if ($this->app_is_initializing || $this->sc_teve_excl || $this->sc_teve_incl || (isset($_POST['master_nav']) && 'on' == $_POST['master_nav']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['total']))
          {
      ...
      if ((isset($_POST['master_nav']) && 'on' == $_POST['master_nav']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['total']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['reg_I_E'] = 0; 
          ...
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->codigo_))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['reg_start'] += ($this->sc_max_reg + $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['reg_I_E']); 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['reg_start'] > $qt_geral_reg_form_articulos)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['reg_start'] = $qt_geral_reg_form_articulos - $this->sc_max_reg; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['reg_start'] = ($qt_geral_reg_form_articulos + 1) - $this->sc_max_reg; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['reg_start'] < 0)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['reg_start'] = 0; 
          }
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['ordem_cmp'] != $this->nmgp_ordem)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['ordem_cmp'] = $this->nmgp_ordem; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['ordem_ord'] = ' asc'; 
          }
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['ordem_ord'] == ' asc')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['ordem_ord'] = ' desc'; 
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['ordem_ord'] = ' asc'; 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['ordem_cmp'])) 
      { 
          $sc_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['ordem_cmp'] . $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['ordem_ord']; 
      } 
      ...
      else
      {
          ...
          { 
              ...
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, $this->sc_max_reg, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['reg_start'] . ")" ; 
                  $rs = $this->Db->SelectLimit($nmgp_select, $this->sc_max_reg, $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['reg_start']) ; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, $this->sc_max_reg, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['reg_start'] . ")" ; 
          ...
          if ($rs->EOF && !$this->proc_fast_search && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['empty_filter']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['empty_filter'])) 
          { 
              $this->nm_flag_saida_novo = "S"; 
              $this->nmgp_opcao = "novo"; 
              $this->sc_evento  = "novo"; 
          ...
          { 
              ...
              if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['parms'])) 
              { 
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['parms'] = "codigo_?#?$this->codigo_?@?";
              } 
...
//
//-- 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['dados_select'][$sc_seq_vert] = $this->nmgp_dados_select;
              $this->nm_guardar_campos();
              $this->nm_formatar_campos();
             $this->form_vert_form_articulos[$sc_seq_vert]['codigo_'] =  $this->codigo_; 
             $this->form_vert_form_articulos[$sc_seq_vert]['nombre_'] =  $this->nombre_; 
          ...
          ksort ($this->form_vert_form_articulos); 
          $rs->Close(); 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['reg_qtd'] = $sc_seq_vert + $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['reg_start'] - 1;
          if ('total' == $this->form_paginacao)
          {
          ...
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              ...
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['reg_start'] < (($qt_geral_reg_form_articulos + 1) - $this->sc_max_reg);
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['opcao'] = '';
          }
      } 
      if ($this->nmgp_opcao == "novo") 
      { 
          ...
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['embutida_multi']) 
          { 
          } 
          else 
          { 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['reg_start'] + $this->sc_max_reg;
       ...
       foreach ($Arr_result as $Ind_result => $Lin_result)
       {
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['record_state'][$sc_seq_vert]['buttons'] = array(
                        'delete' => $this->nmgp_botoes['delete'],
                        'update' => $this->nmgp_botoes['update']
                );
        }
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
<?php
   ...
   {
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['table_refresh'] = true;
   ...
   else
   {
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['csrf_token'];
    }
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_articulos_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['masterValue'] as $cmp_master => $val_master)
        {
?>
