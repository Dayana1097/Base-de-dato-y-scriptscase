<?php  
  ...
  session_start() ;
  class form_cajeros_form_teste
  {
   function form_cajeros_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_cajeros/img";
...
<?php
  ...
  $frm_teste = new form_cajeros_form_teste();
  $frm_teste->form_cajeros_teste();
?>
