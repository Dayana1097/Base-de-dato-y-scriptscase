...
$old_error_handler = set_error_handler("form_cajeros_scriptcase_error_handler");

function form_cajeros_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_cajeros']['contr_erro']) && $_SESSION['scriptcase']['form_cajeros']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_cajeros->contr_form_cajeros->Apl_com_erro = true;
            if ($inicial_form_cajeros->contr_form_cajeros->NM_ajax_flag)
            {
                $inicial_form_cajeros->contr_form_cajeros->NM_ajax_info['errList']['geral_form_cajeros'][] = $msg;
                return;
            }
            form_cajeros_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_cajeros_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_cajeros'])  && '' != $_SESSION['scriptcase']['error_icon']['form_cajeros'])  ? $_SESSION['scriptcase']['error_icon']['form_cajeros']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['form_cajeros']) && '' != $_SESSION['scriptcase']['error_close']['form_cajeros']) ? $_SESSION['scriptcase']['error_close']['form_cajeros'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_cajeros']) && '' != $_SESSION['scriptcase']['error_span_title']['form_cajeros']) ? $_SESSION['scriptcase']['error_span_title']['form_cajeros'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_cajeros']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_cajeros']) ? $_SESSION['scriptcase']['error_icon_title']['form_cajeros'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['form_cajeros']['error_buffer'] .= ob_get_flush();
}
