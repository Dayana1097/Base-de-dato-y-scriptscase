...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "codigo";$Nm_numeric[] = "capacidad";$Nm_numeric[] = "codigo";$Nm_numeric[] = "capacidad";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      ...
      <br><span id="id_hide_codigo"  <?php echo $str_hide_codigo?>><INPUT  type="text" id="SC_codigo" name="codigo" value="<?php echo NM_encode_input($codigo) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_lugar_cond" name="lugar_cond" onChange="nm_campos_between(document.getElementById('id_vis_lugar'), this, 'lugar')">
      ...
      <br><span id="id_hide_lugar"  <?php echo $str_hide_lugar?>><?php
      if ($lugar != "")
      {
      $lugar_look = substr($this->Db->qstr($lugar), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_capacidad_cond" name="capacidad_cond" onChange="nm_campos_between(document.getElementById('id_vis_capacidad'), this, 'capacidad')">
      ...
      <br><span id="id_hide_capacidad"  <?php echo $str_hide_capacidad?>><INPUT  type="text" id="SC_capacidad" name="capacidad" value="<?php echo NM_encode_input($capacidad) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
