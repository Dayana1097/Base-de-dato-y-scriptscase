<?php  
  ...
  session_start() ;
  class grid_almacenes_form_teste
  {
  function grid_almacenes_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_almacenes</FONT></B> 
<br> 
<br> 
...
<input type=submit value="grid_almacenes"> 
</form> 
...
<?php
  ...
  $frm_teste = new grid_almacenes_form_teste();
  $frm_teste->grid_almacenes_teste();
?>
