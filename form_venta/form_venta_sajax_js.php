  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_venta" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_venta_form();
	}

  // ---------- Validate num_venta_
  function do_ajax_form_venta_validate_num_venta_(iNumLinha)
  {
    var nomeCampo_num_venta_ = "num_venta_" + iNumLinha;
    var var_num_venta_ = scAjaxGetFieldText(nomeCampo_num_venta_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_venta_validate_num_venta_(var_num_venta_, iNumLinha, var_script_case_init, do_ajax_form_venta_validate_num_venta__cb);
  } // do_ajax_form_venta_validate_num_venta_

  function do_ajax_form_venta_validate_num_venta__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "num_venta_" + iLineNumber;
    }
    else
    {
      sFieldValid = "num_venta_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "num_venta_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "num_venta_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_venta_validate_num_venta__cb

  // ---------- Validate maquina_
  function do_ajax_form_venta_validate_maquina_(iNumLinha)
  {
    var nomeCampo_maquina_ = "maquina_" + iNumLinha;
    var var_maquina_ = scAjaxGetFieldText(nomeCampo_maquina_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_venta_validate_maquina_(var_maquina_, iNumLinha, var_script_case_init, do_ajax_form_venta_validate_maquina__cb);
  } // do_ajax_form_venta_validate_maquina_

  function do_ajax_form_venta_validate_maquina__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "maquina_" + iLineNumber;
    }
    else
    {
      sFieldValid = "maquina_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "maquina_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "maquina_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_venta_validate_maquina__cb

  // ---------- Validate producto_
  function do_ajax_form_venta_validate_producto_(iNumLinha)
  {
    var nomeCampo_producto_ = "producto_" + iNumLinha;
    var var_producto_ = scAjaxGetFieldText(nomeCampo_producto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_venta_validate_producto_(var_producto_, iNumLinha, var_script_case_init, do_ajax_form_venta_validate_producto__cb);
  } // do_ajax_form_venta_validate_producto_

  function do_ajax_form_venta_validate_producto__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_venta_validate_producto__cb

  // ---------- Validate cajero_
  function do_ajax_form_venta_validate_cajero_(iNumLinha)
  {
    var nomeCampo_cajero_ = "cajero_" + iNumLinha;
    var var_cajero_ = scAjaxGetFieldText(nomeCampo_cajero_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_venta_validate_cajero_(var_cajero_, iNumLinha, var_script_case_init, do_ajax_form_venta_validate_cajero__cb);
  } // do_ajax_form_venta_validate_cajero_

  function do_ajax_form_venta_validate_cajero__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "cajero_" + iLineNumber;
    }
    else
    {
      sFieldValid = "cajero_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "cajero_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "cajero_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_venta_validate_cajero__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_venta_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_venta_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_venta_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_venta_add_new_line_cb);
  } // do_ajax_form_venta_add_new_line

  function do_ajax_form_venta_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_venta_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_venta_backup_line(iNumLinha)
  {
    var var_num_venta_ = scAjaxGetFieldText("num_venta_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_venta_backup_line(var_num_venta_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_venta_backup_line_cb);
  } // do_ajax_form_venta_backup_line

  function do_ajax_form_venta_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_venta_backup_line_cb

  function do_ajax_form_venta_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_venta_cancel_insert

  function do_ajax_form_venta_cancel_update(iSeqVert)
  {
    do_ajax_form_venta_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_venta_cancel_update

  function do_ajax_form_venta_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_venta_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_venta_table_refresh()
  {
    var var_num_venta_ = document.F2.num_venta_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_venta_table_refresh(var_num_venta_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_venta_table_refresh_cb);
  } //  do_ajax_form_venta_table_refresh

  function do_ajax_form_venta_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.num_venta_.value = scAjaxGetKeyValue("num_venta_");
    ...
    scQSInit = false;
    scAjaxAlert(do_ajax_form_venta_table_refresh_cb_after_alert);
  } // do_ajax_form_venta_table_refresh_cb
  function do_ajax_form_venta_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_venta_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_venta_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_venta_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_num_venta_ = scAjaxGetFieldText("num_venta_" + iNumLinha);
    var var_maquina_ = scAjaxGetFieldText("maquina_" + iNumLinha);
    var var_producto_ = scAjaxGetFieldText("producto_" + iNumLinha);
    var var_cajero_ = scAjaxGetFieldText("cajero_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_venta_submit_form(var_num_venta_, var_maquina_, var_producto_, var_cajero_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_venta_submit_form_cb);
  } // do_ajax_form_venta_submit_form

  function do_ajax_form_venta_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("num_venta_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("maquina_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("producto_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("cajero_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_venta_submit_form_cb_after_alert);
  } // do_ajax_form_venta_submit_form_cb
  function do_ajax_form_venta_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_venta_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_venta_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_venta_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("num_venta_" + iNavForm);
      scAjaxHideErrorDisplay("maquina_" + iNavForm);
      scAjaxHideErrorDisplay("producto_" + iNavForm);
      scAjaxHideErrorDisplay("cajero_" + iNavForm);
    }
    var var_num_venta_ = document.F2.num_venta_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_venta_navigate_form(var_num_venta_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_venta_navigate_form_cb);
  } // do_ajax_form_venta_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_venta']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_venta_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.num_venta_.value = scAjaxGetKeyValue("num_venta_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_venta_navigate_form_cb_after_alert);
  } // do_ajax_form_venta_navigate_form_cb
  function do_ajax_form_venta_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_venta_navigate_form_cb_after_alert
  function sc_hide_form_venta_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "num_venta_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "maquina_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "producto_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "cajero_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["num_venta_" + iNumLinha] = {"label": "Num Venta<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["maquina_" + iNumLinha] = {"label": "Maquina<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["cajero_" + iNumLinha] = {"label": "Cajero<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["num_venta_"][iNumLinha] = "num_venta_" + iNumLinha;
    ajax_field_mult["maquina_"][iNumLinha] = "maquina_" + iNumLinha;
    ajax_field_mult["producto_"][iNumLinha] = "producto_" + iNumLinha;
    ajax_field_mult["cajero_"][iNumLinha] = "cajero_" + iNumLinha;
    ajax_field_id["num_venta_" + iNumLinha] = new Array("hidden_field_label_num_venta_", "hidden_field_data_num_venta_" + iNumLinha);
    ajax_field_id["maquina_" + iNumLinha] = new Array("hidden_field_label_maquina_", "hidden_field_data_maquina_" + iNumLinha);
    ajax_field_id["producto_" + iNumLinha] = new Array("hidden_field_label_producto_", "hidden_field_data_producto_" + iNumLinha);
    ajax_field_id["cajero_" + iNumLinha] = new Array("hidden_field_label_cajero_", "hidden_field_data_cajero_" + iNumLinha);
    ajax_error_count["num_venta_" + iNumLinha] = "off";
    ajax_error_count["maquina_" + iNumLinha] = "off";
    ajax_error_count["producto_" + iNumLinha] = "off";
    ajax_error_count["cajero_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["num_venta_" + iNumLinha] = "on";
    ajax_read_only["maquina_" + iNumLinha] = "off";
    ajax_read_only["producto_" + iNumLinha] = "off";
    ajax_read_only["cajero_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["num_venta_" + iNumLinha] = "on";
    ajax_read_only["maquina_" + iNumLinha] = "on";
    ajax_read_only["producto_" + iNumLinha] = "on";
    ajax_read_only["cajero_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["num_venta_" + iNumLinha] = null;
    ajax_error_list["maquina_" + iNumLinha] = null;
    ajax_error_list["producto_" + iNumLinha] = null;
    ajax_error_list["cajero_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["num_venta_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["num_venta_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["num_venta_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["num_venta_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["num_venta_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["maquina_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["maquina_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["maquina_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["maquina_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["maquina_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["cajero_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["cajero_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["cajero_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["cajero_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["cajero_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['num_venta_'])) ? $this->nmgp_cmp_readonly['num_venta_'] : 'on';
?>
    scAjaxFieldRead("num_venta_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['maquina_'])) ? $this->nmgp_cmp_readonly['maquina_'] : 'off';
?>
    scAjaxFieldRead("maquina_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['cajero_'])) ? $this->nmgp_cmp_readonly['cajero_'] : 'off';
?>
    scAjaxFieldRead("cajero_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("num_venta_" + iSeq, "on");
    scAjaxFieldRead("maquina_" + iSeq, "on");
    scAjaxFieldRead("producto_" + iSeq, "on");
    scAjaxFieldRead("cajero_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["num_venta_" + iRow] || "on" == ajax_error_count["maquina_" + iRow] || "on" == ajax_error_count["producto_" + iRow] || "on" == ajax_error_count["cajero_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_num_venta_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_maquina_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_producto_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_cajero_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["num_venta_" + iRow] && "off" == ajax_error_count["maquina_" + iRow] && "off" == ajax_error_count["producto_" + iRow] && "off" == ajax_error_count["cajero_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["num_venta_" + iRow] = "off";
        ajax_error_count["maquina_" + iRow] = "off";
        ajax_error_count["producto_" + iRow] = "off";
        ajax_error_count["cajero_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_num_venta_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_maquina_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_producto_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_cajero_" + iRow).removeClass("scFormErrorLine");
    }
  }
