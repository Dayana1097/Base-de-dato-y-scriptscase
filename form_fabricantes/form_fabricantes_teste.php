<?php  
  ...
  session_start() ;
  class form_fabricantes_form_teste
  {
   function form_fabricantes_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_fabricantes/img";
...
<?php
  ...
  $frm_teste = new form_fabricantes_form_teste();
  $frm_teste->form_fabricantes_teste();
?>
