...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "codigo";$Nm_numeric[] = "precio";$Nm_numeric[] = "fabricante";$Nm_numeric[] = "codigo";$Nm_numeric[] = "precio";$Nm_numeric[] = "fabricante";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_fabricante_cond" name="fabricante_cond" onChange="nm_campos_between(document.getElementById('id_vis_fabricante'), this, 'fabricante')">
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      ...
      <br><span id="id_hide_codigo"  <?php echo $str_hide_codigo?>><INPUT  type="text" id="SC_codigo" name="codigo" value="<?php echo NM_encode_input($codigo) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_precio_cond" name="precio_cond" onChange="nm_campos_between(document.getElementById('id_vis_precio'), this, 'precio')">
      ...
      <br><span id="id_hide_precio"  <?php echo $str_hide_precio?>><INPUT  type="text" id="SC_precio" name="precio" value="<?php echo NM_encode_input($precio) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
