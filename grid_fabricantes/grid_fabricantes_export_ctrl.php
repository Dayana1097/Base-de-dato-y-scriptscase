<?php
@session_start() ;
$_SESSION['scriptcase']['grid_fabricantes']['sc_process_barr'] = true;
require_once('../grid_fabricantes/index.php');
unset($_SESSION['scriptcase']['grid_fabricantes']['sc_process_barr']);
$ExportCtrl = new grid_fabricantes_export_control;
$ExportCtrl->Export_barr();

class grid_fabricantes_export_control
{
