...
function scEventControl_init(iSeqRow) {
  ...
  scEventControl_data["pelicula_" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
}
...
function scEventControl_active(iSeqRow) {
  ...
  if (scEventControl_data["pelicula_" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["pelicula_" + iSeqRow]["change"]) {
    return true;
  }
  return false;
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_codigo_' + iSeqRow).bind('blur', function() { sc_form_salas_codigo__onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_salas_codigo__onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_salas_codigo__onfocus(this, iSeqRow) });
  $('#id_sc_field_nombre_' + iSeqRow).bind('blur', function() { sc_form_salas_nombre__onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_salas_nombre__onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_salas_nombre__onfocus(this, iSeqRow) });
  $('#id_sc_field_pelicula_' + iSeqRow).bind('blur', function() { sc_form_salas_pelicula__onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_salas_pelicula__onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_salas_pelicula__onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_salas_codigo__onblur(oThis, iSeqRow) {
  do_ajax_form_salas_validate_codigo_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_salas_codigo__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_salas_codigo__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_salas_nombre__onblur(oThis, iSeqRow) {
  do_ajax_form_salas_validate_nombre_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_salas_nombre__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_salas_nombre__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_salas_pelicula__onblur(oThis, iSeqRow) {
  do_ajax_form_salas_validate_pelicula_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_salas_pelicula__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_salas_pelicula__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}
...
function displayChange_field_pelicula_(row, status) {
}
...
function scHidePage(pageNo) {
	$("#id_form_salas_form" + pageNo).hide();
}
