<?php
@session_start() ;
$_SESSION['scriptcase']['grid_fabricantes_1']['sc_process_barr'] = true;
require_once('../grid_fabricantes_1/index.php');
unset($_SESSION['scriptcase']['grid_fabricantes_1']['sc_process_barr']);
$ExportCtrl = new grid_fabricantes_1_export_control;
$ExportCtrl->Export_barr();

class grid_fabricantes_1_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> fabricantes :: Excel</TITLE>
