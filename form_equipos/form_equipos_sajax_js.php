  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_equipos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_equipos_form();
	}

  // ---------- Validate numserie_
  function do_ajax_form_equipos_validate_numserie_(iNumLinha)
  {
    var nomeCampo_numserie_ = "numserie_" + iNumLinha;
    var var_numserie_ = scAjaxGetFieldText(nomeCampo_numserie_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_equipos_validate_numserie_(var_numserie_, iNumLinha, var_script_case_init, do_ajax_form_equipos_validate_numserie__cb);
  } // do_ajax_form_equipos_validate_numserie_

  function do_ajax_form_equipos_validate_numserie__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_equipos_validate_numserie__cb

  // ---------- Validate nombre_
  function do_ajax_form_equipos_validate_nombre_(iNumLinha)
  {
    var nomeCampo_nombre_ = "nombre_" + iNumLinha;
    var var_nombre_ = scAjaxGetFieldText(nomeCampo_nombre_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_equipos_validate_nombre_(var_nombre_, iNumLinha, var_script_case_init, do_ajax_form_equipos_validate_nombre__cb);
  } // do_ajax_form_equipos_validate_nombre_

  function do_ajax_form_equipos_validate_nombre__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_equipos_validate_nombre__cb

  // ---------- Validate facultad_
  function do_ajax_form_equipos_validate_facultad_(iNumLinha)
  {
    var nomeCampo_facultad_ = "facultad_" + iNumLinha;
    var var_facultad_ = scAjaxGetFieldText(nomeCampo_facultad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_equipos_validate_facultad_(var_facultad_, iNumLinha, var_script_case_init, do_ajax_form_equipos_validate_facultad__cb);
  } // do_ajax_form_equipos_validate_facultad_

  function do_ajax_form_equipos_validate_facultad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_equipos_validate_facultad__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_equipos_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_equipos_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_equipos_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_equipos_add_new_line_cb);
  } // do_ajax_form_equipos_add_new_line

  function do_ajax_form_equipos_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_equipos_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_equipos_backup_line(iNumLinha)
  {
    var var_numserie_ = scAjaxGetFieldText("numserie_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_equipos_backup_line(var_numserie_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_equipos_backup_line_cb);
  } // do_ajax_form_equipos_backup_line

  function do_ajax_form_equipos_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_equipos_backup_line_cb

  function do_ajax_form_equipos_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_equipos_cancel_insert

  function do_ajax_form_equipos_cancel_update(iSeqVert)
  {
    do_ajax_form_equipos_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_equipos_cancel_update

  function do_ajax_form_equipos_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_equipos_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_equipos_table_refresh()
  {
    var var_numserie_ = document.F2.numserie_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_equipos_table_refresh(var_numserie_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_equipos_table_refresh_cb);
  } //  do_ajax_form_equipos_table_refresh

  function do_ajax_form_equipos_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.numserie_.value = scAjaxGetKeyValue("numserie_");
    ...
    scQSInit = false;
    scAjaxAlert(do_ajax_form_equipos_table_refresh_cb_after_alert);
  } // do_ajax_form_equipos_table_refresh_cb
  function do_ajax_form_equipos_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_equipos_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_equipos_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_equipos_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_equipos_submit_form(var_numserie_, var_nombre_, var_facultad_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_equipos_submit_form_cb);
  } // do_ajax_form_equipos_submit_form

  function do_ajax_form_equipos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_equipos_submit_form_cb_after_alert);
  } // do_ajax_form_equipos_submit_form_cb
  function do_ajax_form_equipos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_equipos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_equipos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_equipos_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_equipos_navigate_form(var_numserie_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_equipos_navigate_form_cb);
  } // do_ajax_form_equipos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_equipos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_equipos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.numserie_.value = scAjaxGetKeyValue("numserie_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_equipos_navigate_form_cb_after_alert);
  } // do_ajax_form_equipos_navigate_form_cb
  function do_ajax_form_equipos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_equipos_navigate_form_cb_after_alert
  function sc_hide_form_equipos_form()
  {
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['numserie_'])) ? $this->nmgp_cmp_readonly['numserie_'] : 'on';
?>
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["numserie_" + iRow] || "on" == ajax_error_count["nombre_" + iRow] || "on" == ajax_error_count["facultad_" + iRow]))
    {
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["numserie_" + iRow] && "off" == ajax_error_count["nombre_" + iRow] && "off" == ajax_error_count["facultad_" + iRow]))
    {
      if (bErrorRow)
      {
