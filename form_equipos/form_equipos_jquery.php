...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_numserie_' + iSeqRow).bind('blur', function() { sc_form_equipos_numserie__onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_equipos_numserie__onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_equipos_numserie__onfocus(this, iSeqRow) });
  $('#id_sc_field_nombre_' + iSeqRow).bind('blur', function() { sc_form_equipos_nombre__onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_equipos_nombre__onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_equipos_nombre__onfocus(this, iSeqRow) });
  $('#id_sc_field_facultad_' + iSeqRow).bind('blur', function() { sc_form_equipos_facultad__onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_equipos_facultad__onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_equipos_facultad__onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_equipos_numserie__onblur(oThis, iSeqRow) {
  do_ajax_form_equipos_validate_numserie_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_equipos_numserie__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_equipos_numserie__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_equipos_nombre__onblur(oThis, iSeqRow) {
  do_ajax_form_equipos_validate_nombre_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_equipos_nombre__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_equipos_nombre__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_equipos_facultad__onblur(oThis, iSeqRow) {
  do_ajax_form_equipos_validate_facultad_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_equipos_facultad__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_equipos_facultad__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}
...
function scHidePage(pageNo) {
	$("#id_form_equipos_form" + pageNo).hide();
}
