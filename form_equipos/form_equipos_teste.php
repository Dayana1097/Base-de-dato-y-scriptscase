<?php  
  ...
  session_start() ;
  class form_equipos_form_teste
  {
   function form_equipos_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_equipos/img";
...
<?php
  ...
  $frm_teste = new form_equipos_form_teste();
  $frm_teste->form_equipos_teste();
?>
