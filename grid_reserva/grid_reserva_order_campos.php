...
<?php
   ...
   $Ord_Cmp = new grid_reserva_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_reserva_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_reserva']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_reserva']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reserva']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_reserva']['labels']["id"] : "Id";
   $tab_ger_campos['dni'] = "on";
   $tab_def_campos['dni'] = "DNI";
   $tab_labels["dni"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reserva']['labels']["dni"])) ? $_SESSION['sc_session'][$sc_init]['grid_reserva']['labels']["dni"] : "DNI";
   $tab_ger_campos['numserie'] = "on";
   $tab_def_campos['numserie'] = "NumSerie";
   $tab_labels["numserie"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reserva']['labels']["numserie"])) ? $_SESSION['sc_session'][$sc_init]['grid_reserva']['labels']["numserie"] : "Num Serie";
   $tab_ger_campos['comienzo'] = "on";
   $tab_def_campos['comienzo'] = "Comienzo";
   $tab_labels["comienzo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reserva']['labels']["comienzo"])) ? $_SESSION['sc_session'][$sc_init]['grid_reserva']['labels']["comienzo"] : "Comienzo";
   $tab_ger_campos['fin'] = "on";
   $tab_def_campos['fin'] = "Fin";
   $tab_labels["fin"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reserva']['labels']["fin"])) ? $_SESSION['sc_session'][$sc_init]['grid_reserva']['labels']["fin"] : "Fin";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_reserva']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_reserva']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_reserva']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_reserva']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_reserva']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_reserva']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_reserva']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_reserva']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_reserva']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_reserva_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_reserva']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_reserva']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_reserva']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_reserva']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_reserva']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
