...
class grid_reserva_rtf
{
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reserva']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reserva']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reserva']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reserva']['rtf_name']);
      }
   ...
   function NM_export_comienzo()
   {
         ...
         $this->comienzo = str_replace('<', '&lt;', $this->comienzo);
         $this->comienzo = str_replace('>', '&gt;', $this->comienzo);
         $this->Texto_tag .= "<td>" . $this->comienzo . "</td>\r\n";
   }
   //----- fin
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reserva']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reserva']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> reserva :: RTF</TITLE>
