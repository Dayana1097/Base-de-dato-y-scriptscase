<?php
@session_start() ;
$_SESSION['scriptcase']['grid_reserva']['sc_process_barr'] = true;
require_once('../grid_reserva/index.php');
unset($_SESSION['scriptcase']['grid_reserva']['sc_process_barr']);
$ExportCtrl = new grid_reserva_export_control;
$ExportCtrl->Export_barr();

class grid_reserva_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> reserva :: Excel</TITLE>
