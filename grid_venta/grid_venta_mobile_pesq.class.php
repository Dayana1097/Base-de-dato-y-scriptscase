...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "num_venta";$Nm_numeric[] = "maquina";$Nm_numeric[] = "producto";$Nm_numeric[] = "cajero";$Nm_numeric[] = "num_venta";$Nm_numeric[] = "maquina";$Nm_numeric[] = "producto";$Nm_numeric[] = "cajero";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_cajero_cond" name="cajero_cond" onChange="nm_campos_between(document.getElementById('id_vis_cajero'), this, 'cajero')">
      ...
      <br><span id="id_hide_cajero"  <?php echo $str_hide_cajero?>><INPUT  type="text" id="SC_cajero" name="cajero" value="<?php echo NM_encode_input($cajero) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_num_venta_cond" name="num_venta_cond" onChange="nm_campos_between(document.getElementById('id_vis_num_venta'), this, 'num_venta')">
      ...
      <br><span id="id_hide_num_venta"  <?php echo $str_hide_num_venta?>><INPUT  type="text" id="SC_num_venta" name="num_venta" value="<?php echo NM_encode_input($num_venta) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_maquina_cond" name="maquina_cond" onChange="nm_campos_between(document.getElementById('id_vis_maquina'), this, 'maquina')">
      ...
      <br><span id="id_hide_maquina"  <?php echo $str_hide_maquina?>><INPUT  type="text" id="SC_maquina" name="maquina" value="<?php echo NM_encode_input($maquina) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_producto_cond" name="producto_cond" onChange="nm_campos_between(document.getElementById('id_vis_producto'), this, 'producto')">
      ...
      <br><span id="id_hide_producto"  <?php echo $str_hide_producto?>><INPUT  type="text" id="SC_producto" name="producto" value="<?php echo NM_encode_input($producto) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
