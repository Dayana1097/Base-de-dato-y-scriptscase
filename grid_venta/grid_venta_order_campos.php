...
<?php
   ...
   $Ord_Cmp = new grid_venta_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_venta_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_venta']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_venta']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['num_venta'] = "Num_venta";
   $tab_labels["num_venta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_venta']['labels']["num_venta"])) ? $_SESSION['sc_session'][$sc_init]['grid_venta']['labels']["num_venta"] : "Num Venta";
   $tab_ger_campos['maquina'] = "on";
   $tab_def_campos['maquina'] = "Maquina";
   $tab_labels["maquina"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_venta']['labels']["maquina"])) ? $_SESSION['sc_session'][$sc_init]['grid_venta']['labels']["maquina"] : "Maquina";
   $tab_ger_campos['producto'] = "on";
   $tab_def_campos['producto'] = "Producto";
   $tab_labels["producto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_venta']['labels']["producto"])) ? $_SESSION['sc_session'][$sc_init]['grid_venta']['labels']["producto"] : "Producto";
   $tab_ger_campos['cajero'] = "on";
   $tab_def_campos['cajero'] = "Cajero";
   $tab_labels["cajero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_venta']['labels']["cajero"])) ? $_SESSION['sc_session'][$sc_init]['grid_venta']['labels']["cajero"] : "Cajero";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_venta']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_venta']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_venta']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_venta']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_venta']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_venta']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_venta']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_venta']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_venta']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_venta_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_venta']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_venta']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_venta']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_venta']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_venta']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
