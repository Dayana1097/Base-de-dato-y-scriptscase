<?php  
  ...
  session_start() ;
  class grid_venta_form_teste
  {
  function grid_venta_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_venta</FONT></B> 
<br> 
<br> 
...
<input type=submit value="grid_venta"> 
</form> 
...
<?php
  ...
  $frm_teste = new grid_venta_form_teste();
  $frm_teste->grid_venta_teste();
?>
