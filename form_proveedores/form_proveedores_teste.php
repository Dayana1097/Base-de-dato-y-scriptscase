<?php  
  ...
  session_start() ;
  class form_proveedores_form_teste
  {
   function form_proveedores_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_proveedores/img";
...
<?php
  ...
  $frm_teste = new form_proveedores_form_teste();
  $frm_teste->form_proveedores_teste();
?>
