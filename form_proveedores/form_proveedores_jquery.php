...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id_' + iSeqRow).bind('blur', function() { sc_form_proveedores_id__onblur(this, iSeqRow) })
                                 .bind('change', function() { sc_form_proveedores_id__onchange(this, iSeqRow) })
                                 .bind('focus', function() { sc_form_proveedores_id__onfocus(this, iSeqRow) });
  $('#id_sc_field_nombre_' + iSeqRow).bind('blur', function() { sc_form_proveedores_nombre__onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_proveedores_nombre__onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_proveedores_nombre__onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_proveedores_id__onblur(oThis, iSeqRow) {
  do_ajax_form_proveedores_validate_id_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_proveedores_id__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_proveedores_id__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_proveedores_nombre__onblur(oThis, iSeqRow) {
  do_ajax_form_proveedores_validate_nombre_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_proveedores_nombre__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}

function sc_form_proveedores_nombre__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}
...
function scHidePage(pageNo) {
	$("#id_form_proveedores_form" + pageNo).hide();
}
